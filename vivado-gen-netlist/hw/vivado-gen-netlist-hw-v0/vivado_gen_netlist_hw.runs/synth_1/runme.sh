...
HD_PWD='/home/alen/git/AMD-FPGA-Practice/vivado-gen-netlist/hw/vivado-gen-netlist-hw-v0/vivado_gen_netlist_hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log raa225502_phase_add_drop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source raa225502_phase_add_drop.tcl
