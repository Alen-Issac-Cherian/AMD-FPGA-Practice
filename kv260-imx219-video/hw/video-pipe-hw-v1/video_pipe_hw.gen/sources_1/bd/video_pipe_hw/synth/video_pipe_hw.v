...
(* CORE_GENERATION_INFO = "video_pipe_hw,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=video_pipe_hw,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=20,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "video_pipe_hw.hwdef" *) 
module video_pipe_hw
  ...
  wire [5:0]axi_smc_1_M02_AXI_ARADDR;
  wire axi_smc_1_M02_AXI_ARREADY;
  wire axi_smc_1_M02_AXI_ARVALID;
  wire [5:0]axi_smc_1_M02_AXI_AWADDR;
  ...
  video_pipe_hw_axi_vdma_0_0 axi_vdma_0
       (.axi_resetn(proc_sys_reset_2_peripheral_aresetn),
        ...
        .s_axi_lite_aclk(clk_wiz_2_clk_out1),
        ...
        .s_axis_s2mm_aclk(clk_wiz_2_clk_out1),
  ...
  video_pipe_hw_clk_wiz_1_1 clk_wiz_2
       (.clk_in1(zynq_ultra_ps_e_0_pl_clk0),
  ...
  video_pipe_hw_mipi_csi2_rx_subsyst_0_0 mipi_csi2_rx_subsyst_0
       (.csirxss_s_axi_araddr(axi_smc_1_M01_AXI_ARADDR[7:0]),
        ...
        .video_aclk(clk_wiz_2_clk_out1),
        .video_aresetn(proc_sys_reset_2_peripheral_aresetn),
  ...
  video_pipe_hw_proc_sys_reset_0_1 proc_sys_reset_2
       (.aux_reset_in(1'b1),
  ...
  video_pipe_hw_v_demosaic_0_0 v_demosaic_0
       (.ap_clk(clk_wiz_2_clk_out1),
        ...
        .s_axi_CTRL_ARADDR(axi_smc_1_M02_AXI_ARADDR),
        .s_axi_CTRL_ARREADY(axi_smc_1_M02_AXI_ARREADY),
        .s_axi_CTRL_ARVALID(axi_smc_1_M02_AXI_ARVALID),
        .s_axi_CTRL_AWADDR(axi_smc_1_M02_AXI_AWADDR),
        .s_axi_CTRL_AWREADY(axi_smc_1_M02_AXI_AWREADY),
        .s_axi_CTRL_AWVALID(axi_smc_1_M02_AXI_AWVALID),
        .s_axi_CTRL_BREADY(axi_smc_1_M02_AXI_BREADY),
        .s_axi_CTRL_BRESP(axi_smc_1_M02_AXI_BRESP),
        .s_axi_CTRL_BVALID(axi_smc_1_M02_AXI_BVALID),
        .s_axi_CTRL_RDATA(axi_smc_1_M02_AXI_RDATA),
        .s_axi_CTRL_RREADY(axi_smc_1_M02_AXI_RREADY),
        .s_axi_CTRL_RRESP(axi_smc_1_M02_AXI_RRESP),
        .s_axi_CTRL_RVALID(axi_smc_1_M02_AXI_RVALID),
        .s_axi_CTRL_WDATA(axi_smc_1_M02_AXI_WDATA),
        .s_axi_CTRL_WREADY(axi_smc_1_M02_AXI_WREADY),
        .s_axi_CTRL_WSTRB(axi_smc_1_M02_AXI_WSTRB),
        .s_axi_CTRL_WVALID(axi_smc_1_M02_AXI_WVALID),
  ...
  video_pipe_hw_zynq_ultra_ps_e_0_1 zynq_ultra_ps_e_0
       (.dp_external_custom_event1(1'b0),
        ...
        .maxihpm1_fpd_aclk(clk_wiz_2_clk_out1),
