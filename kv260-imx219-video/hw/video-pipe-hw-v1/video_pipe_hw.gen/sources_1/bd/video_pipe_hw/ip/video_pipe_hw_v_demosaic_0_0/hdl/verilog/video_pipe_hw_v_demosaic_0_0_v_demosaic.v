...
(* CORE_GENERATION_INFO="video_pipe_hw_v_demosaic_0_0_v_demosaic,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=20.408001,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=12.757000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=6239,HLS_SYN_LUT=10744,HLS_VERSION=2025_2}" *)

(* DowngradeIPIdentifiedWarnings="yes" *)
module video_pipe_hw_v_demosaic_0_0_v_demosaic (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
video_pipe_hw_v_demosaic_0_0_CTRL_s_axi #(
...
video_pipe_hw_v_demosaic_0_0_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
video_pipe_hw_v_demosaic_0_0_AXIvideo2MultiBayer AXIvideo2MultiBayer_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
video_pipe_hw_v_demosaic_0_0_Debayer Debayer_U0(
...
video_pipe_hw_v_demosaic_0_0_ZipperRemoval ZipperRemoval_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
video_pipe_hw_v_demosaic_0_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
video_pipe_hw_v_demosaic_0_0_fifo_w16_d3_S bayer_phase_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
video_pipe_hw_v_demosaic_0_0_fifo_w10_d2_S imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_x imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_x imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
video_pipe_hw_v_demosaic_0_0_start_for_Debayer_U0 start_for_Debayer_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
video_pipe_hw_v_demosaic_0_0_start_for_ZipperRemoval_U0 start_for_ZipperRemoval_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
video_pipe_hw_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "video_pipe_hw_v_demosaic_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "video_pipe_hw_v_demosaic_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //video_pipe_hw_v_demosaic_0_0_v_demosaic
