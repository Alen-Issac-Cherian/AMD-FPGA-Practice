...
--               /home/alen/git/AMD-FPGA-Practice/kv260-imx219-video/hw/video-pipe-hw-v1/video_pipe_hw.gen/sources_1/bd/video_pipe_hw/ip/video_pipe_hw_mipi_csi2_rx_subsyst_0_0/video_pipe_hw_mipi_csi2_rx_subsyst_0_0_stub.vhdl
...
entity video_pipe_hw_mipi_csi2_rx_subsyst_0_0 is
  ...
  attribute CORE_GENERATION_INFO of video_pipe_hw_mipi_csi2_rx_subsyst_0_0 : entity is "video_pipe_hw_mipi_csi2_rx_subsyst_0_0,bd_0c52,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=mipi_csi2_rx_subsystem,x_ipVersion=6.0,x_ipCoreRevision=7,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_PHY_MODE=DPHY,C_EXT_MMCM=0,C_EN_RXPPI_AS_MON=false,C_EXDESBOARD_VERSION=2,C_INT_QOR_CHECK=0,C_LPRX_DISABLE_EXTPORT=0,C_OOC_VID_CLK=6.666,C_CLK_IO_SWAP=false,C_DL0_IO_SWAP=false,C_DL1_IO_SWAP=false,C_DL2_IO_SWAP=false,C_DL3_IO_SWAP=false,C_CLK_LP_IO_SWAP=false,C_DL0_LP_IO_SWAP=false,C_DL1_LP_IO_SWAP=false,C_DL2_LP_IO_SWAP=false,C_DL3_LP_IO_SWAP=false,VFB_TU_WIDTH=1,C_IDLY_GROUP_NAME=mipi_csi2rx_idly_group,C_EN_EXDESIGNS=false,C_EXDES_BOARD=ZCU102,C_EXDES_FMC=LI-IMX274MIPI-FMC V1.0 Single Sensor,C_EXDES_CONFIG=MIPI_Video_Pipe_Camera_to_Display,C_CSI2RX_DBG=0,C_MIPI_SLV_INT=0,C_CSI_OPT1_REGS=false,C_CSI_EN_CRC=true,C_CSI_EN_ACTIVELANES=true,DPHY_PRESET=CSI2RX_XLNX,C_STRETCH_LINE_RATE=4500,C_DPHY_MODE=SLAVE,C_EN_BG0_PIN0=false,C_EN_BG0_PIN6=false,C_EN_BG1_PIN0=false,C_EN_BG1_PIN6=false,C_EN_BG2_PIN0=false,C_EN_BG2_PIN6=false,C_EN_BG3_PIN0=false,C_EN_BG3_PIN6=false,CMN_PXL_FORMAT=RAW10,CMN_NUM_LANES=2,C_EN_7S_LINERATE_CHECK=false,C_DPHY_LANES=2,YUV420_BUF_DPTH=128,C_EN_CSI_V2_0=false,C_EN_VCX=false,C_SPRT_ISP_BRIDGE=false,C_DEBUG_BUS=false,CMN_VC=All,CMN_NUM_PIXELS=1,CMN_INC_IIC=false,CMN_INC_VFB=true,CMN_PROJ_FAMILY=1,CMN_FIFO_RD_EN_CNTRL=true,C_HS_LINE_RATE=800,DPY_LINE_RATE=486,DPY_EN_REG_IF=false,CSI_EMB_NON_IMG=false,CSI_BUF_DEPTH=4096,AXIS_TDATA_WIDTH=32,AXIS_TUSER_WIDTH=96,AXIS_TDEST_WIDTH=4,HP_IO_BANK_SELECTION=66,CLK_LANE_IO_LOC=G1,DATA_LANE0_IO_LOC=E1,DATA_LANE1_IO_LOC=F2,DATA_LANE2_IO_LOC=None,DATA_LANE3_IO_LOC=None,DATA_LANE0_BYTE=All_Byte,DATA_LANE1_BYTE=All_Byte,DATA_LANE2_BYTE=All_Byte,DATA_LANE3_BYTE=All_Byte,CLK_LANE_IO_LOC_NAME=IO_L1P_T0L_N0_DBC_66,DATA_LANE0_IO_LOC_NAME=IO_L2P_T0L_N2_66,DATA_LANE1_IO_LOC_NAME=IO_L3P_T0L_N4_AD15P_66,DATA_LANE2_IO_LOC_NAME=None,DATA_LANE3_IO_LOC_NAME=None,SupportLevel=1,C_CLK_LANE_IO_POSITION=0,C_DATA_LANE0_IO_POSITION=2,C_DATA_LANE1_IO_POSITION=4,C_DATA_LANE2_IO_POSITION=6,C_DATA_LANE3_IO_POSITION=8,C_IS_7SERIES=false,C_IS_VERSAL=false,C_EN_CNTS_BYTE_CLK=false,C_RCVE_DESKEW_SEQ=false,C_MASTER_RIU=true,C_SEP_RIU=false,C_RCVE_ALT_DESKEW_SEQ=false,C_RCVE_PREAMBLE_SEQ=false,C_CAL_MODE=NONE,C_IDLY_TAP=1,C_EN_EXT_TAP=false,C_EN_CLK300M=false,C_SHARE_IDLYCTRL=false,C_FIFO_RD_EN_CONTROL=true,C_HS_SETTLE_NS=155,C_EN_TIMEOUT_REGS=false,C_HS_TIMEOUT=65541,C_ESC_TIMEOUT=25600,C_INIT=100000,C_CSI_FILTER_USERDATATYPE=false,USE_BOARD_FLOW=false,DPHYRX_BOARD_INTERFACE=Custom,CSI_CONTROLLER_REG_IF=true,C_IS_KSB=false,C_INC_PHY=true,C_CLOCK_MASK=39,C_DBG_PORTS_ON=false,Component_Name=video_pipe_hw_mipi_csi2_rx_subsyst_0_0}";
...
architecture stub of video_pipe_hw_mipi_csi2_rx_subsyst_0_0 is
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_0c52,Vivado 2025.2";
begin
end;
