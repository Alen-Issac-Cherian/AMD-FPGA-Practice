...
-- Date        : Sat Aug 29 16:05:43 2026
-- Host        : hp-HP-Pavilion-Laptop-14-ec0xxx running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top video_pipe_hw_clk_wiz_0_0 -prefix
--               video_pipe_hw_clk_wiz_0_0_ video_pipe_hw_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : video_pipe_hw_clk_wiz_0_0
...
entity video_pipe_hw_clk_wiz_0_0_video_pipe_hw_clk_wiz_0_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end video_pipe_hw_clk_wiz_0_0_video_pipe_hw_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of video_pipe_hw_clk_wiz_0_0_video_pipe_hw_clk_wiz_0_0_clk_wiz is
  signal clk_in1_video_pipe_hw_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_video_pipe_hw_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_video_pipe_hw_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_video_pipe_hw_clk_wiz_0_0,
      O => clk_out1
    );
plle4_adv_inst: unisim.vcomponents.PLLE4_ADV
    generic map(
      ...
      CLKIN => clk_in1_video_pipe_hw_clk_wiz_0_0,
      CLKOUT0 => clk_out1_video_pipe_hw_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity video_pipe_hw_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of video_pipe_hw_clk_wiz_0_0 : entity is true;
end video_pipe_hw_clk_wiz_0_0;

architecture STRUCTURE of video_pipe_hw_clk_wiz_0_0 is
begin
inst: entity work.video_pipe_hw_clk_wiz_0_0_video_pipe_hw_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1
    );
