...
entity video_pipe_hw_v_demosaic_0_0_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity video_pipe_hw_v_demosaic_0_0_regslice_both;

architecture behave of video_pipe_hw_v_demosaic_0_0_regslice_both is
