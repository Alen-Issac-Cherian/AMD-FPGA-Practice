...
entity video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S is 
    generic (
...
architecture rtl of video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S is
...
------------------------Component----------------------
    component video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 30;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_ShiftReg : video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_ShiftReg
    generic map (
...
entity video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 30;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_ShiftReg;

architecture rtl of video_pipe_hw_v_demosaic_0_0_fifo_w30_d2_S_ShiftReg is
