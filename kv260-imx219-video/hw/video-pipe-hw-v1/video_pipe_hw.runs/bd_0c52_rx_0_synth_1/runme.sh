...
HD_PWD='/home/alen/git/AMD-FPGA-Practice/kv260-imx219-video/hw/video-pipe-hw-v1/video_pipe_hw.runs/bd_0c52_rx_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_0c52_rx_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_0c52_rx_0.tcl
