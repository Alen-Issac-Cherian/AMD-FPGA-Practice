...
HD_PWD='/home/alen/git/AMD-FPGA-Practice/kv260-imx219-video/hw/video-pipe-hw-v1/video_pipe_hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_pipe_hw_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_pipe_hw_wrapper.tcl
