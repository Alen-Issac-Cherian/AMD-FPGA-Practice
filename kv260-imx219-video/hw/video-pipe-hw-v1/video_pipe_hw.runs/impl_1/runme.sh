...
HD_PWD='/home/alen/git/AMD-FPGA-Practice/kv260-imx219-video/hw/video-pipe-hw-v1/video_pipe_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log video_pipe_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source video_pipe_hw_wrapper.tcl -notrace
