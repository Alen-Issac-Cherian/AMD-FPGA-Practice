...
HD_PWD='/home/alen/git/AMD-FPGA-Practice/kv260-imx219-video/hw/video-pipe-hw-v0/video_pipe_hw.runs/video_pipe_hw_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_pipe_hw_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_pipe_hw_vio_0_0.tcl
