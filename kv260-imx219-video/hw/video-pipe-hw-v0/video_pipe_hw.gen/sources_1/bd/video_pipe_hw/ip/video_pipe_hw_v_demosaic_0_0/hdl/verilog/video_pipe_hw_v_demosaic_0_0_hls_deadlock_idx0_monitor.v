...
module video_pipe_hw_v_demosaic_0_0_hls_deadlock_idx0_monitor ( // for module video_pipe_hw_v_demosaic_0_0_v_demosaic_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 video_pipe_hw_v_demosaic_0_0_hls_deadlock_idx1_monitor video_pipe_hw_v_demosaic_0_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
