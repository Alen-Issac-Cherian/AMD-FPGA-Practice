...
export RDI_DATADIR="/home/alen/AMD-Xilinx/2025.2/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L mipi_dphy_v4_3_17 -L zynq_ultra_ps_e_vip_v1_0_22 -L xilinx_vip"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alen/AMD-Xilinx/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb video_pipe_hw.wdb xsim.dir libdpi.so)
