...
#define I2S_TX_MCLK  12288000
#define I2S_TX_FS    48000

#define I2S_RX_INTR_ID   XPAR_FABRIC_I2S_RECEIVER_0_IRQ_INTR
#define I2S_TX_INTR_ID   XPAR_FABRIC_I2S_TRANSMITTER_0_IRQ_INTR

volatile u32 RxOverflowCount = 0;
volatile u32 TxUnderflowCount = 0;
...
int InitI2SCores(void) {
    ...
    XI2s_Rx_JustifyEnable(&I2sRxInstance, FALSE);
    XI2s_Tx_JustifyEnable(&I2sTxInstance, FALSE);
