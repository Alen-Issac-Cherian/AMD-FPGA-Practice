...
HD_PWD='/home/alen/git/AMD-FPGA-Practice/zybo-z7-audio/hw/audio-pipe-hw-v0/audio_pipe_hw.runs/audio_pipe_hw_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_pipe_hw_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_pipe_hw_clk_wiz_0_0.tcl
