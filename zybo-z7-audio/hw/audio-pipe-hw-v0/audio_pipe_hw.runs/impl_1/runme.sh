...
HD_PWD='/home/alen/git/AMD-FPGA-Practice/zybo-z7-audio/hw/audio-pipe-hw-v0/audio_pipe_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_pipe_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_pipe_hw_wrapper.tcl -notrace
