...
module clahe_accel_MatStream2AxiStream_2_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1340_fu_123_p2;
reg    rows_blk_n;
reg    cols_bound_per_npc_blk_n;
reg   [3:0] last_blk_width_read_reg_141;
reg    ap_block_state1;
reg   [10:0] strideBased_cols_bound_per_npc_reg_146;
reg   [10:0] rows_int16_reg_153;
wire   [11:0] sub_fu_96_p2;
reg   [11:0] sub_reg_158;
wire    ap_CS_fsm_state2;
wire   [21:0] bound_fu_109_p2;
reg   [21:0] bound_reg_163;
...
reg    ap_block_state4;
wire   [11:0] cols_bound_per_npc_cast8_fu_93_p1;
wire   [10:0] bound_fu_109_p0;
wire   [10:0] bound_fu_109_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_ST_fsm_state1_blk;
wire    ap_ST_fsm_state2_blk;
reg    ap_ST_fsm_state3_blk;
reg    ap_ST_fsm_state4_blk;
wire   [21:0] bound_fu_109_p00;
wire   [21:0] bound_fu_109_p10;
wire    ap_ce_reg;
...
clahe_accel_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (*) begin
    if (((icmp_ln1340_fu_123_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state4) & (icmp_ln1340_fu_123_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    ap_block_state4 = ((icmp_ln1340_fu_123_p2 == 1'd0) & (ldata_full_n == 1'b0));
end

assign bound_fu_109_p0 = bound_fu_109_p00;

assign bound_fu_109_p00 = rows_int16_reg_153;

assign bound_fu_109_p1 = bound_fu_109_p10;

assign bound_fu_109_p10 = strideBased_cols_bound_per_npc_reg_146;

assign cols_bound_per_npc_cast8_fu_93_p1 = strideBased_cols_bound_per_npc_reg_146;
...
assign icmp_ln1340_fu_123_p2 = ((grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_filled_out == 8'd0) ? 1'b1 : 1'b0);

assign sub_fu_96_p2 = ($signed(cols_bound_per_npc_cast8_fu_93_p1) + $signed(12'd4095));

endmodule //clahe_accel_MatStream2AxiStream_2_s
