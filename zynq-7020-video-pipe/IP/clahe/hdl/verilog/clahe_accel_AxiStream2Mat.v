...
module clahe_accel_AxiStream2Mat (
        ldata_dout,
        ldata_empty_n,
        ldata_read,
        imgInput_data_din,
...
wire   [10:0] entry_proc1_U0_rows_c_din;
wire    entry_proc1_U0_rows_c_write;
wire    entry_proc1_U0_cols_read;
wire   [10:0] entry_proc1_U0_cols_c_din;
...
clahe_accel_entry_proc1 entry_proc1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
clahe_accel_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
clahe_accel_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
clahe_accel_fifo_w11_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
clahe_accel_fifo_w11_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
clahe_accel_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //clahe_accel_AxiStream2Mat
