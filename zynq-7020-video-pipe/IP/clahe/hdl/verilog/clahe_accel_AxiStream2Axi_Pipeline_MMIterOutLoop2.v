...
module clahe_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [17:0] i_fu_58;
wire   [17:0] add_ln1379_fu_106_p2;
wire    ap_loop_init;
reg   [17:0] ap_sig_allocacmp_i_7;
reg    ap_done_reg;
...
assign add_ln1379_fu_106_p2 = (ap_sig_allocacmp_i_7 + 18'd1);
...
assign icmp_ln1379_fu_100_p2 = ((ap_sig_allocacmp_i_7 == p_read) ? 1'b1 : 1'b0);
...
endmodule //clahe_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2
