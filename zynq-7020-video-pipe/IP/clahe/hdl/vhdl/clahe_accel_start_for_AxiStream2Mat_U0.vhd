...
entity clahe_accel_start_for_AxiStream2Mat_U0 is 
    generic (
...
architecture rtl of clahe_accel_start_for_AxiStream2Mat_U0 is

    component clahe_accel_start_for_AxiStream2Mat_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_clahe_accel_start_for_AxiStream2Mat_U0_ShiftReg : clahe_accel_start_for_AxiStream2Mat_U0_ShiftReg
    generic map (
...
entity clahe_accel_start_for_AxiStream2Mat_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end clahe_accel_start_for_AxiStream2Mat_U0_ShiftReg;

architecture rtl of clahe_accel_start_for_AxiStream2Mat_U0_ShiftReg is
