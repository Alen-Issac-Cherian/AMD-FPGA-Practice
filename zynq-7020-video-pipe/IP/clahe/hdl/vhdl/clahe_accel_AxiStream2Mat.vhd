...
entity clahe_accel_AxiStream2Mat is
port (
...
architecture behav of clahe_accel_AxiStream2Mat is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc1_U0_rows_c_din : STD_LOGIC_VECTOR (10 downto 0);
    signal entry_proc1_U0_rows_c_write : STD_LOGIC;
    signal entry_proc1_U0_cols_read : STD_LOGIC;
    signal entry_proc1_U0_cols_c_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component clahe_accel_entry_proc1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component clahe_accel_last_blk_pxl_width IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component clahe_accel_AxiStream2MatStream_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component clahe_accel_fifo_w11_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component clahe_accel_fifo_w4_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc1_U0 : component clahe_accel_entry_proc1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    last_blk_pxl_width_U0 : component clahe_accel_last_blk_pxl_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2MatStream_2_U0 : component clahe_accel_AxiStream2MatStream_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    rows_c_U : component clahe_accel_fifo_w11_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    cols_c_U : component clahe_accel_fifo_w11_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    last_blk_width_channel_U : component clahe_accel_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
