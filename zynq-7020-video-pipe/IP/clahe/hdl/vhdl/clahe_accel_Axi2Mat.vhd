...
architecture behav of clahe_accel_Axi2Mat is 
...
attribute shreg_extract : string;
    ...
    signal Axi2AxiStream_U0_rows_c_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component clahe_accel_Axi2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component clahe_accel_AxiStream2Mat IS
    port (
    ...
    component clahe_accel_fifo_w128_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component clahe_accel_fifo_w11_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component clahe_accel_start_for_AxiStream2Mat_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Axi2AxiStream_U0 : component clahe_accel_Axi2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2Mat_U0 : component clahe_accel_AxiStream2Mat
    port map (
    ...
    ldata_U : component clahe_accel_fifo_w128_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    rows_c_U : component clahe_accel_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c_U : component clahe_accel_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_AxiStream2Mat_U0_U : component clahe_accel_start_for_AxiStream2Mat_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
