// -------------------------------------------------------------
// 
// File Name: d:\soc_prj\hdlcoder\CLAHE\hdlsrc\CLAHEAlgorithm_fpga\clahe_ip_adapter_in_module.v
...
// -------------------------------------------------------------
// 
// Module: clahe_ip_adapter_in_module
// Source Path: clahe_ip/clahe_ip_axi4_stream_video_0_slave/clahe_ip_adapter_in/clahe_ip_adapter_in_module
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module clahe_ip_adapter_in_module
  ...
  wire [15:0] data_constant0;  // ufix16
  reg [15:0] data_reg;  // ufix16
  wire [15:0] data_reg_temp;  // ufix16
  wire [15:0] data_buf;  // ufix16
  reg [15:0] data_buf_delay_1;  // ufix16
  reg [15:0] data_buf_delay1;  // ufix16
  wire [15:0] data_out_output;  // ufix16
  reg [15:0] data_out_2;  // ufix16
  reg  hstart_2;  // ufix1
  ...
  assign data_constant0 = 16'b0000000000000000;
  ...
  always @(posedge clk)
    begin : data_buf_delay_process
      if (reset == 1'b1) begin
        data_buf_delay_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : Delay11_process
      if (reset == 1'b1) begin
        data_buf_delay1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
...
endmodule  // clahe_ip_adapter_in_module
