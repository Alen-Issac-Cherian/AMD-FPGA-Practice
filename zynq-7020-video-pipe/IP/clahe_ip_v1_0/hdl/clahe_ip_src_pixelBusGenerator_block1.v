// -------------------------------------------------------------
// 
// File Name: d:\soc_prj\hdlcoder\CLAHE\hdlsrc\CLAHEAlgorithm_fpga\clahe_ip_src_pixelBusGenerator_block1.v
...
// -------------------------------------------------------------
// 
// Module: clahe_ip_src_pixelBusGenerator_block1
// Source Path: CLAHEAlgorithm_fpga/CLAHE/CLAHEHDLAlgorithm/tileGeneration/histResetBuffer/pixelBusGenerator
// Hierarchy Level: 4
// Model version: 424
// 
// -------------------------------------------------------------
...
module clahe_ip_src_pixelBusGenerator_block1
  ...
  wire [18:0] count_reset_1;  // ufix19
  ...
  assign count_reset_1 = 19'b0000000000000000000;



  assign count_3 = Vertical_out1 + count_step_1;
  ...
  assign count_4 = (validIn == 1'b0 ? Vertical_out1 :
              count_value_1);



  assign count_5 = (reset_1 == 1'b0 ? count_4 :
              count_reset_1);
  ...
  clahe_ip_src_Pixel_Control_Bus_Creator_block4 u_Pixel_Control_Bus_Creator (.In1(Logical_Operator3_out1),
...
endmodule  // clahe_ip_src_pixelBusGenerator_block1
