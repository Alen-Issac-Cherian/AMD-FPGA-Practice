// -------------------------------------------------------------
// 
// File Name: d:\soc_prj\hdlcoder\CLAHE\hdlsrc\CLAHEAlgorithm_fpga\clahe_ip_adapter_in.v
...
// -------------------------------------------------------------
// 
// Module: clahe_ip_adapter_in
// Source Path: clahe_ip/clahe_ip_axi4_stream_video_0_slave/clahe_ip_adapter_in
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module clahe_ip_adapter_in
  ...
  input   clk;
  input   reset;
  input   [15:0] stream_in_fifo_user_data;  // ufix16
  ...
  clahe_ip_adapter_in_module u_clahe_ip_clahe_ip_axi4_stream_video_0_slave_clahe_ip_adapter_in_clahe_ip_adapter_in_module (.clk(clk),
                                                                                                                           .reset(reset),
                                                                                                                           .enb(adapter_in_enable),
                                                                                                                           .data_in(stream_in_fifo_user_data),  // ufix16
