...
entity tonemapping_accel_tonemapping_accel_i_Block_entry1_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tonemapping_accel_tonemapping_accel_i_Block_entry1_proc is 
...
begin
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state1, height, ap_block_state1, ap_return_0_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_0 <= height;
        else 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm_state1, width, ap_block_state1, ap_return_1_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_1 <= width;
        else 
    ...
    ap_return_2_assign_proc : process(ap_CS_fsm_state1, height, ap_block_state1, ap_return_2_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_2 <= height;
        else 
    ...
    ap_return_3_assign_proc : process(ap_CS_fsm_state1, width, ap_block_state1, ap_return_3_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_3 <= width;
        else 
