...
entity tonemapping_accel_Mat2AxiStream is
port (
...
architecture behav of tonemapping_accel_Mat2AxiStream is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_rows_c_din : STD_LOGIC_VECTOR (9 downto 0);
    signal entry_proc_U0_rows_c_write : STD_LOGIC;
    signal entry_proc_U0_cols_c_din : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal MatStream2AxiStream_2_U0_ldata_din : STD_LOGIC_VECTOR (127 downto 0);
    ...
    component tonemapping_accel_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component tonemapping_accel_last_blk_pxl_width_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component tonemapping_accel_MatStream2AxiStream_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component tonemapping_accel_fifo_w10_d3_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component tonemapping_accel_fifo_w4_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component tonemapping_accel_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    last_blk_pxl_width_1_U0 : component tonemapping_accel_last_blk_pxl_width_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MatStream2AxiStream_2_U0 : component tonemapping_accel_MatStream2AxiStream_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    rows_c_U : component tonemapping_accel_fifo_w10_d3_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    cols_c_U : component tonemapping_accel_fifo_w10_d3_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    last_blk_width_channel_U : component tonemapping_accel_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
