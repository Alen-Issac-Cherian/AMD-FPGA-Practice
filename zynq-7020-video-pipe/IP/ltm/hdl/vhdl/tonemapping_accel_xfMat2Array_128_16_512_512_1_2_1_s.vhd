...
entity tonemapping_accel_xfMat2Array_128_16_512_512_1_2_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tonemapping_accel_xfMat2Array_128_16_512_512_1_2_1_s is 
...
attribute shreg_extract : string;
    ...
    signal dstPtr_read_reg_83 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_Mat2Axi_fu_62_imgOutput_data_read : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWVALID : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_WVALID : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_WDATA : STD_LOGIC_VECTOR (127 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_WSTRB : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_WLAST : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARVALID : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_RREADY : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem_out_BREADY : STD_LOGIC;
    ...
    component tonemapping_accel_Mat2Axi IS
    port (
        imgOutput_data_dout : IN STD_LOGIC_VECTOR (23 downto 0);
        imgOutput_data_empty_n : IN STD_LOGIC;
        imgOutput_data_read : OUT STD_LOGIC;
...
begin
    grp_Mat2Axi_fu_62 : component tonemapping_accel_Mat2Axi
    port map (
        imgOutput_data_dout => imgOutput_data_dout,
        imgOutput_data_empty_n => imgOutput_data_empty_n,
        imgOutput_data_read => grp_Mat2Axi_fu_62_imgOutput_data_read,
        m_axi_gmem_out_AWVALID => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWVALID,
        m_axi_gmem_out_AWREADY => m_axi_gmem_out_AWREADY,
        m_axi_gmem_out_AWADDR => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWADDR,
        m_axi_gmem_out_AWID => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWID,
        m_axi_gmem_out_AWLEN => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWLEN,
        m_axi_gmem_out_AWSIZE => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWSIZE,
        m_axi_gmem_out_AWBURST => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWBURST,
        m_axi_gmem_out_AWLOCK => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWLOCK,
        m_axi_gmem_out_AWCACHE => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWCACHE,
        m_axi_gmem_out_AWPROT => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWPROT,
        m_axi_gmem_out_AWQOS => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWQOS,
        m_axi_gmem_out_AWREGION => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWREGION,
        m_axi_gmem_out_AWUSER => grp_Mat2Axi_fu_62_m_axi_gmem_out_AWUSER,
        m_axi_gmem_out_WVALID => grp_Mat2Axi_fu_62_m_axi_gmem_out_WVALID,
        m_axi_gmem_out_WREADY => m_axi_gmem_out_WREADY,
        m_axi_gmem_out_WDATA => grp_Mat2Axi_fu_62_m_axi_gmem_out_WDATA,
        m_axi_gmem_out_WSTRB => grp_Mat2Axi_fu_62_m_axi_gmem_out_WSTRB,
        m_axi_gmem_out_WLAST => grp_Mat2Axi_fu_62_m_axi_gmem_out_WLAST,
        m_axi_gmem_out_WID => grp_Mat2Axi_fu_62_m_axi_gmem_out_WID,
        m_axi_gmem_out_WUSER => grp_Mat2Axi_fu_62_m_axi_gmem_out_WUSER,
        m_axi_gmem_out_ARVALID => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARVALID,
        m_axi_gmem_out_ARREADY => ap_const_logic_0,
        m_axi_gmem_out_ARADDR => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARADDR,
        m_axi_gmem_out_ARID => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARID,
        m_axi_gmem_out_ARLEN => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARLEN,
        m_axi_gmem_out_ARSIZE => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARSIZE,
        m_axi_gmem_out_ARBURST => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARBURST,
        m_axi_gmem_out_ARLOCK => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARLOCK,
        m_axi_gmem_out_ARCACHE => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARCACHE,
        m_axi_gmem_out_ARPROT => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARPROT,
        m_axi_gmem_out_ARQOS => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARQOS,
        m_axi_gmem_out_ARREGION => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARREGION,
        m_axi_gmem_out_ARUSER => grp_Mat2Axi_fu_62_m_axi_gmem_out_ARUSER,
        m_axi_gmem_out_RVALID => ap_const_logic_0,
        m_axi_gmem_out_RREADY => grp_Mat2Axi_fu_62_m_axi_gmem_out_RREADY,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                dstPtr_read_reg_83 <= dstPtr_dout;
            end if;
        end if;
    end process;
    ...
    imgOutput_data_read_assign_proc : process(grp_Mat2Axi_fu_62_imgOutput_data_read, ap_CS_fsm_state3)
    begin
    ...
    m_axi_gmem_out_AWVALID_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem_out_AWVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
    ...
    m_axi_gmem_out_BREADY_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem_out_BREADY, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem_out_BREADY <= grp_Mat2Axi_fu_62_m_axi_gmem_out_BREADY;
        else 
    ...
    m_axi_gmem_out_WVALID_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem_out_WVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem_out_WVALID <= grp_Mat2Axi_fu_62_m_axi_gmem_out_WVALID;
        else 
