...
entity tonemapping_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tonemapping_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1021_fu_96_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem_in_addr_read_reg_135 : STD_LOGIC_VECTOR (127 downto 0);
    signal c_fu_56 : STD_LOGIC_VECTOR (16 downto 0) := "00000000000000000";
    signal c_2_fu_102_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_c_1 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1021_fu_96_p2 = ap_const_lv1_0))) then 
                    c_fu_56 <= c_2_fu_102_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    c_fu_56 <= ap_const_lv17_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem_in_RVALID)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (m_axi_gmem_in_RVALID = ap_const_logic_0);
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1021_fu_96_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1021_fu_96_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_c_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, c_fu_56, ap_loop_init)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_c_1 <= ap_const_lv17_0;
        else 
            ap_sig_allocacmp_c_1 <= c_fu_56;
        end if; 
    end process;

    c_2_fu_102_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_c_1) + unsigned(ap_const_lv17_1));

    gmem_in_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_gmem_in_RVALID, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln1021_fu_96_p2 <= "1" when (ap_sig_allocacmp_c_1 = cols_addrbound) else "0";
    ...
    ldata_din <= gmem_in_addr_read_reg_135;
    ...
    m_axi_gmem_in_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
