...
module tonemapping_accel_AxiStream2Mat (
        ldata_dout,
        ldata_empty_n,
        ldata_read,
        imgInput_data_din,
...
wire    entry_proc1_U0_rows_read;
wire   [9:0] entry_proc1_U0_rows_c_din;
wire    entry_proc1_U0_rows_c_write;
wire    entry_proc1_U0_cols_read;
wire   [9:0] entry_proc1_U0_cols_c_din;
wire    entry_proc1_U0_cols_c_write;
...
wire   [1:0] last_blk_pxl_width_U0_return_r;
...
wire   [29:0] AxiStream2MatStream_2_U0_imgInput_data_din;
...
wire    cols_c_empty_n;
wire   [1:0] last_blk_width_channel_dout;
...
tonemapping_accel_entry_proc1 entry_proc1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
tonemapping_accel_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
tonemapping_accel_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
tonemapping_accel_fifo_w10_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
tonemapping_accel_fifo_w10_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
tonemapping_accel_fifo_w2_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc1_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_U0_ap_ready & ap_sync_entry_proc1_U0_ap_ready);

assign cols_read = entry_proc1_U0_cols_read;
...
assign rows_read = entry_proc1_U0_rows_read;

endmodule //tonemapping_accel_AxiStream2Mat
