...
module tonemapping_accel_Mat2AxiStream (
        imgOutput_data_dout,
...
wire   [9:0] entry_proc_U0_rows_c_din;
wire    entry_proc_U0_rows_c_write;
wire   [9:0] entry_proc_U0_cols_c_din;
...
wire   [127:0] MatStream2AxiStream_2_U0_ldata_din;
...
tonemapping_accel_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
tonemapping_accel_last_blk_pxl_width_1 last_blk_pxl_width_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
tonemapping_accel_MatStream2AxiStream_2_s MatStream2AxiStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
tonemapping_accel_fifo_w10_d3_S_x rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
tonemapping_accel_fifo_w10_d3_S_x cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
tonemapping_accel_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //tonemapping_accel_Mat2AxiStream
