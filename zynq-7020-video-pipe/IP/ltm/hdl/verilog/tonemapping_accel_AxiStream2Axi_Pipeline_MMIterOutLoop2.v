...
module tonemapping_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1379_fu_100_p2;
...
reg   [127:0] ldata_read_reg_139;
reg    ap_block_pp0_stage0_01001;
reg   [16:0] i_fu_58;
wire   [16:0] add_ln1379_fu_106_p2;
wire    ap_loop_init;
reg   [16:0] ap_sig_allocacmp_i_10;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1379_fu_100_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1379_fu_100_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln1379_fu_106_p2 = (ap_sig_allocacmp_i_10 + 17'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_gmem_out_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_gmem_out_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end
...
assign icmp_ln1379_fu_100_p2 = ((ap_sig_allocacmp_i_10 == p_read) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_out_WDATA = ldata_read_reg_139;

assign m_axi_gmem_out_WID = 1'd0;

assign m_axi_gmem_out_WLAST = 1'b0;

assign m_axi_gmem_out_WSTRB = 16'd65535;

assign m_axi_gmem_out_WUSER = 1'd0;

endmodule //tonemapping_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2
