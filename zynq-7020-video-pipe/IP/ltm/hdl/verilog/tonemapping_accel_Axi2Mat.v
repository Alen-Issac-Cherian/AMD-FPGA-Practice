...
module tonemapping_accel_Axi2Mat (
...
wire   [9:0] Axi2AxiStream_U0_rows_c_din;
wire    Axi2AxiStream_U0_rows_c_write;
wire   [9:0] Axi2AxiStream_U0_cols_c_din;
wire    Axi2AxiStream_U0_cols_c_write;
wire    AxiStream2Mat_U0_ldata_read;
wire   [29:0] AxiStream2Mat_U0_imgInput_data_din;
...
tonemapping_accel_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
tonemapping_accel_AxiStream2Mat AxiStream2Mat_U0(
...
tonemapping_accel_fifo_w128_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
tonemapping_accel_fifo_w10_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
tonemapping_accel_fifo_w10_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
tonemapping_accel_start_for_AxiStream2Mat_U0 start_for_AxiStream2Mat_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //tonemapping_accel_Axi2Mat
