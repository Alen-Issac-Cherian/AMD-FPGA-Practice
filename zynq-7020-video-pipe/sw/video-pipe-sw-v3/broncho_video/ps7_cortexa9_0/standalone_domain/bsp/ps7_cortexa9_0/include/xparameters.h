...
/* Definitions for driver QUANTIZATIONDITHERING_ACCEL */
#define XPAR_XQUANTIZATIONDITHERING_ACCEL_NUM_INSTANCES 1

/* Definitions for peripheral QUANTIZATIONDITHERIN_0 */
#define XPAR_QUANTIZATIONDITHERIN_0_DEVICE_ID 0
#define XPAR_QUANTIZATIONDITHERIN_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_QUANTIZATIONDITHERIN_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral QUANTIZATIONDITHERIN_0 */
#define XPAR_XQUANTIZATIONDITHERING_ACCEL_0_DEVICE_ID XPAR_QUANTIZATIONDITHERIN_0_DEVICE_ID
#define XPAR_XQUANTIZATIONDITHERING_ACCEL_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XQUANTIZATIONDITHERING_ACCEL_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
