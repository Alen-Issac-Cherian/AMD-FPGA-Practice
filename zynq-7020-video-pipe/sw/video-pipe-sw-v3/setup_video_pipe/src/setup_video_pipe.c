...
int main()
{
    ...
    //Configure Quantization and Dithering
    Xil_Out32(XPAR_XQUANTIZATIONDITHERING_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x10, 0x190);
    Xil_Out32(XPAR_XQUANTIZATIONDITHERING_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x18, 0x190);
    Xil_Out32(XPAR_XQUANTIZATIONDITHERING_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x00, 0x81);
    xil_printf("Quantization and Dithering Started\r\n");
