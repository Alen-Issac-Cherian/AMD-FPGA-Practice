...
int main()
{
    ...
    xil_printf("VDMA 0 S2MM set!\r\n");

    //Configure HLS CLAHE
    int CLAHE_READ_ADDR = buff_1 + wr_offset;
    int CLAHE_WRITE_ADDR = buff_3 + 0x00600000 + wr_offset;

    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x28, source_height);			//height
    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x30, source_width);			//width
    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x48, 0x8);					//tiles X
    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x40, 0x8);					//tiles Y
    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x10, CLAHE_READ_ADDR);		//IN PTR ADDR
    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x1c, CLAHE_WRITE_ADDR);		//OUT PTR ADDR
    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x38, 0xA3D70A);				//CLIP DATA
    Xil_Out32(XPAR_CLAHE_ACCEL_0_S_AXI_CONTROL_BASEADDR + 0x00, 0x81);					//Control
    xil_printf("HLS CLAHE Started\r\n");

    int buff_4 = CLAHE_WRITE_ADDR + 0x00600000;
    int buff_5 = buff_4 + 0x00600000;

    /* Configure the Read interface (MM2S)*/
    // MM2S Control Register
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0x00, 0x8B);
    // MM2S Start Address 1
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0x5C, CLAHE_WRITE_ADDR - wr_offset);
    ...
    StreamOut_0.VmId           = OutVmPtr->VmId;
