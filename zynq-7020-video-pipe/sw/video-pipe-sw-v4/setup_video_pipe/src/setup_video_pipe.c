...
XVprocSs VprocInst_0;
XVprocSs_Config *VprocCfgPtr_0;
...
XVidC_VideoStream StreamIn_0, StreamOut_0;
int sink_width = 1920, sink_height = 1080;
int source_width = 400, source_height = 400;
int bpp = 2;
...
const VideoTimingMode VideoTimingModes[] = {{XVIDC_VM_400x400_60_P, "400x400@60Hz", XVIDC_FR_60HZ, {400, 48, 32, 80, 560, 1, 400, 3, 10, 6, 419, 0, 0, 0, 0, 1}}};
const XVidC_VideoTimingMode *VmPtr = &VideoTimingModes[0];
...
int main()
{
    ...
    //Configure AXI VDMA
    int buff_1 = 0x10000000;
    int buff_2 = 0x10600000;
    int buff_3 = 0x10C00000;
    ...
    //S2MM Start Address 1
   	Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0xAC, buff_1 + wr_offset);
   	//S2MM Start Address 2
   	Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0xB0, buff_2 + wr_offset);
    //S2MM Start Address 3
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0xB4, buff_3 + wr_offset);
    ...
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0x5C, buff_1);
    // MM2S Start Address 2
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0x60, buff_2);
    // MM2S Start Address 3
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0x64, buff_3);
    ...
    //Configure CLAHE
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x0, 0x1);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x8, 0x190);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0xC, 0x190);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x10, 0x176);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x14, 0x62);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x18, 0x20000000);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x1C, 0x20000000);
    //Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x100, 0xA3D70A);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x0, 0x0);
    Xil_Out32(XPAR_CLAHE_IP_0_BASEADDR + 0x4, 0x1);
    xil_printf("8-bit CLAHE Started\r\n");

    //Configure VPSS 0 as CSC
    VprocCfgPtr_0 = XVprocSs_LookupConfig(XPAR_V_PROC_SS_1_CSC_DEVICE_ID);
    ...
    StreamIn_0.VmId           = VmPtr->VmId;
    StreamIn_0.Timing         = VmPtr->Timing;
    ...
    StreamOut_0.VmId           = VmPtr->VmId;
    StreamOut_0.Timing         = VmPtr->Timing;
    ...
    xil_printf("VPSS 1 CSC Started\r\n");

    //Configure Sensor Demosaic
    Xil_Out32(XPAR_XV_DEMOSAIC_0_S_AXI_CTRL_BASEADDR + 0x10, 0x190);
    Xil_Out32(XPAR_XV_DEMOSAIC_0_S_AXI_CTRL_BASEADDR + 0x18, 0x190);
