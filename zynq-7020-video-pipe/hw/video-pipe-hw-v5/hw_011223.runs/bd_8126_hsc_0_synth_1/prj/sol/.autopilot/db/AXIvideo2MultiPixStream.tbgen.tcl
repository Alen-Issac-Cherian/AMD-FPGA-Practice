...
set C_modelArgList {
	...
	{ stream_in int 30 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_video_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_in", "interface" : "fifo", "bitwidth" : 30, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ stream_in_din sc_out sc_lv 30 signal 7 } 
	...
	{ Height_c20_num_data_valid sc_in sc_lv 3 signal 11 } 
	{ Height_c20_fifo_cap sc_in sc_lv 3 signal 11 } 
	...
	{ WidthIn_c_num_data_valid sc_in sc_lv 3 signal 12 } 
	{ WidthIn_c_fifo_cap sc_in sc_lv 3 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "stream_in", "role": "din" }} , 
 	...
 	{ "name": "Height_c20_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "Height_c20", "role": "num_data_valid" }} , 
 	{ "name": "Height_c20_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "Height_c20", "role": "fifo_cap" }} , 
 	...
 	{ "name": "WidthIn_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "WidthIn_c", "role": "num_data_valid" }} , 
 	{ "name": "WidthIn_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "WidthIn_c", "role": "fifo_cap" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "422", "Max" : "2084406"}
	, {"Name" : "Interval", "Min" : "422", "Max" : "2084406"}
]}
...
set Spec2ImplPortList { 
	...
	stream_in { ap_fifo {  { stream_in_din fifo_data_in 1 30 }  { stream_in_num_data_valid fifo_status_num_data_valid 0 5 }  { stream_in_fifo_cap fifo_update 0 5 }  { stream_in_full_n fifo_status 0 1 }  { stream_in_write fifo_port_we 1 1 } } }
	Height { ap_none {  { Height in_data 0 16 } } }
	WidthIn { ap_none {  { WidthIn in_data 0 16 } } }
	ColorMode { ap_none {  { ColorMode in_data 0 8 } } }
	Height_c20 { ap_fifo {  { Height_c20_din fifo_data_in 1 16 }  { Height_c20_num_data_valid fifo_status_num_data_valid 0 3 }  { Height_c20_fifo_cap fifo_update 0 3 }  { Height_c20_full_n fifo_status 0 1 }  { Height_c20_write fifo_port_we 1 1 } } }
	WidthIn_c { ap_fifo {  { WidthIn_c_din fifo_data_in 1 16 }  { WidthIn_c_num_data_valid fifo_status_num_data_valid 0 3 }  { WidthIn_c_fifo_cap fifo_update 0 3 }  { WidthIn_c_full_n fifo_status 0 1 }  { WidthIn_c_write fifo_port_we 1 1 } } }
}
