...
(* CORE_GENERATION_INFO="bd_8126_vsc_0_v_vscaler,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.090641,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=35,HLS_SYN_DSP=0,HLS_SYN_FF=5169,HLS_SYN_LUT=5511,HLS_VERSION=2023_2}" *)

module bd_8126_vsc_0_v_vscaler (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
wire   [29:0] v_vcresampler_core_U0_SrcYUV422_din;
...
wire   [29:0] vscale_core_polyphase_U0_OutYUV_din;
...
wire    HwReg_LineRate_full_n;
wire   [31:0] HwReg_LineRate_dout;
wire   [2:0] HwReg_LineRate_num_data_valid;
wire   [2:0] HwReg_LineRate_fifo_cap;
wire    HwReg_LineRate_empty_n;
wire    HwReg_HeightIn_c15_full_n;
wire   [10:0] HwReg_HeightIn_c15_dout;
wire   [2:0] HwReg_HeightIn_c15_num_data_valid;
wire   [2:0] HwReg_HeightIn_c15_fifo_cap;
wire    HwReg_HeightIn_c15_empty_n;
wire    HwReg_Width_c18_full_n;
wire   [10:0] HwReg_Width_c18_dout;
wire   [2:0] HwReg_Width_c18_num_data_valid;
wire   [2:0] HwReg_Width_c18_fifo_cap;
wire    HwReg_Width_c18_empty_n;
wire    HwReg_HeightOut_c19_full_n;
wire   [10:0] HwReg_HeightOut_c19_dout;
wire   [2:0] HwReg_HeightOut_c19_num_data_valid;
wire   [2:0] HwReg_HeightOut_c19_fifo_cap;
wire    HwReg_HeightOut_c19_empty_n;
wire    HwReg_ColorMode_c20_full_n;
wire   [7:0] HwReg_ColorMode_c20_dout;
wire   [2:0] HwReg_ColorMode_c20_num_data_valid;
wire   [2:0] HwReg_ColorMode_c20_fifo_cap;
wire    HwReg_ColorMode_c20_empty_n;
wire    ColorMode_vcr_c21_full_n;
wire   [7:0] ColorMode_vcr_c21_dout;
wire   [2:0] ColorMode_vcr_c21_num_data_valid;
wire   [2:0] ColorMode_vcr_c21_fifo_cap;
wire    ColorMode_vcr_c21_empty_n;
wire    SrcYUV_full_n;
...
wire   [2:0] HwReg_HeightIn_c14_num_data_valid;
wire   [2:0] HwReg_HeightIn_c14_fifo_cap;
wire    HwReg_HeightIn_c14_empty_n;
wire    HwReg_Width_c17_full_n;
wire   [10:0] HwReg_Width_c17_dout;
wire   [2:0] HwReg_Width_c17_num_data_valid;
wire   [2:0] HwReg_Width_c17_fifo_cap;
wire    HwReg_Width_c17_empty_n;
wire    HwReg_ColorMode_c_full_n;
wire   [7:0] HwReg_ColorMode_c_dout;
wire   [2:0] HwReg_ColorMode_c_num_data_valid;
wire   [2:0] HwReg_ColorMode_c_fifo_cap;
wire    HwReg_ColorMode_c_empty_n;
wire    SrcYUV422_full_n;
wire   [29:0] SrcYUV422_dout;
...
wire   [2:0] HwReg_HeightIn_c_num_data_valid;
wire   [2:0] HwReg_HeightIn_c_fifo_cap;
wire    HwReg_HeightIn_c_empty_n;
wire    HwReg_Width_c16_full_n;
wire   [10:0] HwReg_Width_c16_dout;
wire   [2:0] HwReg_Width_c16_num_data_valid;
wire   [2:0] HwReg_Width_c16_fifo_cap;
...
wire   [2:0] HwReg_HeightOut_c_num_data_valid;
wire   [2:0] HwReg_HeightOut_c_fifo_cap;
...
bd_8126_vsc_0_Block_entry4_proc Block_entry4_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_8126_vsc_0_AXIvideo2MultiPixStream AXIvideo2MultiPixStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_8126_vsc_0_v_vcresampler_core v_vcresampler_core_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_8126_vsc_0_vscale_core_polyphase vscale_core_polyphase_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_8126_vsc_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_8126_vsc_0_fifo_w32_d2_S HwReg_LineRate_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_HeightIn_c15_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_Width_c18_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_HeightOut_c19_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w8_d2_S HwReg_ColorMode_c20_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w8_d2_S ColorMode_vcr_c21_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w30_d16_S SrcYUV_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_HeightIn_c14_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_Width_c17_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w8_d2_S HwReg_ColorMode_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w30_d16_S SrcYUV422_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_HeightIn_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_Width_c16_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w8_d3_S ColorMode_vcr_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w30_d16_S OutYUV_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_Width_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_fifo_w11_d2_S HwReg_HeightOut_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_start_for_AXIvideo2MultiPixStream_U0 start_for_AXIvideo2MultiPixStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_start_for_v_vcresampler_core_U0 start_for_v_vcresampler_core_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_8126_vsc_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "bd_8126_vsc_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "bd_8126_vsc_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //bd_8126_vsc_0_v_vscaler
