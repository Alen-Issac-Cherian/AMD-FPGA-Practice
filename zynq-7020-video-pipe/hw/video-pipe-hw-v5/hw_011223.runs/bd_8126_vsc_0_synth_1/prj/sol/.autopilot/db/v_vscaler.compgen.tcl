...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_8126_vsc_0_fifo_w30_d16_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {SrcYUV_U}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_8126_vsc_0_fifo_w30_d16_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {SrcYUV422_U}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_8126_vsc_0_fifo_w30_d16_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {OutYUV_U}
}
