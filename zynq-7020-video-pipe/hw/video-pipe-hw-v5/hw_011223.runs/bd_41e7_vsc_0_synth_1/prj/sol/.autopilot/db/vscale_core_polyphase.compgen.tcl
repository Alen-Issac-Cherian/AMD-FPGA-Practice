...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_41e7_vsc_0_vscale_core_polyphase_FiltCoeff_RAM_1P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_1p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_41e7_vsc_0_vscale_core_polyphase_LineBuf_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HeightIn_dout { I 11 vector } HeightIn_num_data_valid { I 3 vector } HeightIn_fifo_cap { I 3 vector } HeightIn_empty_n { I 1 bit } HeightIn_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HeightOut_dout { I 11 vector } HeightOut_num_data_valid { I 3 vector } HeightOut_fifo_cap { I 3 vector } HeightOut_empty_n { I 1 bit } HeightOut_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { LineRate_dout { I 32 vector } LineRate_num_data_valid { I 3 vector } LineRate_fifo_cap { I 3 vector } LineRate_empty_n { I 1 bit } LineRate_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_HeightOut_c_din { O 11 vector } HwReg_HeightOut_c_num_data_valid { I 3 vector } HwReg_HeightOut_c_fifo_cap { I 3 vector } HwReg_HeightOut_c_full_n { I 1 bit } HwReg_HeightOut_c_write { O 1 bit } } \
} "
}
