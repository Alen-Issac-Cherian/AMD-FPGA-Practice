...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_WidthIn \
    op interface \
    ports { WidthIn_dout { I 11 vector } WidthIn_num_data_valid { I 3 vector } WidthIn_fifo_cap { I 3 vector } WidthIn_empty_n { I 1 bit } WidthIn_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_HeightIn_c14_din { O 11 vector } HwReg_HeightIn_c14_num_data_valid { I 3 vector } HwReg_HeightIn_c14_fifo_cap { I 3 vector } HwReg_HeightIn_c14_full_n { I 1 bit } HwReg_HeightIn_c14_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_Width_c17_din { O 11 vector } HwReg_Width_c17_num_data_valid { I 3 vector } HwReg_Width_c17_fifo_cap { I 3 vector } HwReg_Width_c17_full_n { I 1 bit } HwReg_Width_c17_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_ColorMode_c_din { O 8 vector } HwReg_ColorMode_c_num_data_valid { I 3 vector } HwReg_ColorMode_c_fifo_cap { I 3 vector } HwReg_ColorMode_c_full_n { I 1 bit } HwReg_ColorMode_c_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 63
set RegSliceName bd_41e7_vsc_0_regslice_both
set RegSliceInstName bd_41e7_vsc_0_regslice_both_U
set CoreName ap_simcore_bd_41e7_vsc_0_regslice_both
