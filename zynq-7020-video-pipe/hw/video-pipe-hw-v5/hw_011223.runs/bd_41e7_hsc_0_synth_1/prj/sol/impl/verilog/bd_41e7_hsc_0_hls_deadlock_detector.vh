    ...
    reg ap_done_reg_0;// for module v_hcresampler_core_1_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_0 <= 'b0;
        end
        else begin
            ap_done_reg_0 <= v_hcresampler_core_1_U0.ap_done & ~v_hcresampler_core_1_U0.ap_continue;
        end
    end
    ...
    reg ap_done_reg_2;// for module v_hcresampler_core_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_2 <= 'b0;
        end
        else begin
            ap_done_reg_2 <= v_hcresampler_core_U0.ap_done & ~v_hcresampler_core_U0.ap_continue;
        end
    end
...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 0, 7, 4) bd_41e7_hsc_0_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 1, 3, 3) bd_41e7_hsc_0_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~AXIvideo2MultiPixStream_U0.grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_196.stream_in_blk_n) | (~AXIvideo2MultiPixStream_U0.Height_c20_blk_n) | (~AXIvideo2MultiPixStream_U0.WidthIn_c_blk_n);
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 2, 2, 3) bd_41e7_hsc_0_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~v_hcresampler_core_1_U0.grp_v_hcresampler_core_1_Pipeline_VITIS_LOOP_1681_2_fu_162.stream_in_blk_n) | (~v_hcresampler_core_1_U0.Height_blk_n) | (~v_hcresampler_core_1_U0.WidthIn_blk_n);
    ...
    assign proc_2_TLF_FIFO_blk[1] = 1'b0 | (~bPassThruHcr1_channel_U.if_empty_n & v_hcresampler_core_1_U0.ap_idle & ~bPassThruHcr1_channel_U.if_write);
    assign proc_2_input_sync_blk[1] = 1'b0;
    assign proc_2_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_2[1] = dl_detect_out ? proc_dep_vld_vec_2_reg[1] : (proc_2_data_FIFO_blk[1] | proc_2_data_PIPO_blk[1] | proc_2_start_FIFO_blk[1] | proc_2_TLF_FIFO_blk[1] | proc_2_input_sync_blk[1] | proc_2_output_sync_blk[1]);
    assign proc_2_data_FIFO_blk[2] = 1'b0 | (~v_hcresampler_core_1_U0.grp_v_hcresampler_core_1_Pipeline_VITIS_LOOP_1681_2_fu_162.stream_upsampled_blk_n);
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 3, 4, 4) bd_41e7_hsc_0_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 4, 3, 3) bd_41e7_hsc_0_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~v_csc_core_U0.grp_v_csc_core_Pipeline_VITIS_LOOP_2080_2_fu_114.stream_scaled_blk_n) | (~v_csc_core_U0.Height_blk_n) | (~v_csc_core_U0.WidthOut_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~v_csc_core_U0.grp_v_csc_core_Pipeline_VITIS_LOOP_2080_2_fu_114.stream_scaled_csc_blk_n) | (~v_csc_core_U0.Height_c18_blk_n) | (~v_csc_core_U0.WidthOut_c22_blk_n);
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 5, 2, 3) bd_41e7_hsc_0_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~v_hcresampler_core_U0.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1681_2_fu_198.stream_scaled_csc_blk_n) | (~v_hcresampler_core_U0.Height_blk_n) | (~v_hcresampler_core_U0.WidthOut_blk_n);
    ...
    assign proc_5_TLF_FIFO_blk[1] = 1'b0 | (~bPassThruHcr2_channel_U.if_empty_n & v_hcresampler_core_U0.ap_idle & ~bPassThruHcr2_channel_U.if_write);
    assign proc_5_input_sync_blk[1] = 1'b0;
    assign proc_5_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_5[1] = dl_detect_out ? proc_dep_vld_vec_5_reg[1] : (proc_5_data_FIFO_blk[1] | proc_5_data_PIPO_blk[1] | proc_5_start_FIFO_blk[1] | proc_5_TLF_FIFO_blk[1] | proc_5_input_sync_blk[1] | proc_5_output_sync_blk[1]);
    assign proc_5_data_FIFO_blk[2] = 1'b0 | (~v_hcresampler_core_U0.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1681_2_fu_198.stream_out_422_blk_n) | (~v_hcresampler_core_U0.Height_c17_blk_n) | (~v_hcresampler_core_U0.WidthOut_c21_blk_n);
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 6, 2, 3) bd_41e7_hsc_0_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~v_vcresampler_core_U0.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1898_2_fu_138.stream_out_422_blk_n) | (~v_vcresampler_core_U0.Height_blk_n) | (~v_vcresampler_core_U0.WidthOut_blk_n);
    ...
    assign proc_6_data_FIFO_blk[2] = 1'b0 | (~v_vcresampler_core_U0.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1898_2_fu_138.stream_out_420_blk_n) | (~v_vcresampler_core_U0.Height_c_blk_n) | (~v_vcresampler_core_U0.WidthOut_c_blk_n);
    ...
    bd_41e7_hsc_0_hls_deadlock_detect_unit #(8, 7, 2, 2) bd_41e7_hsc_0_hls_deadlock_detect_unit_7 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_7_data_FIFO_blk[0] = 1'b0 | (~MultiPixStream2AXIvideo_U0.grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1589_3_fu_154.stream_out_420_blk_n) | (~MultiPixStream2AXIvideo_U0.Height_blk_n) | (~MultiPixStream2AXIvideo_U0.WidthOut_blk_n);
...
`include "bd_41e7_hsc_0_hls_deadlock_report_unit.vh"
