...
entity bd_41e7_hsc_0_CTRL_s_axi is
generic (
...
end entity bd_41e7_hsc_0_CTRL_s_axi;
...
architecture behave of bd_41e7_hsc_0_CTRL_s_axi is
    ...
    component bd_41e7_hsc_0_CTRL_s_axi_ram is
        generic (
    ...
    end component bd_41e7_hsc_0_CTRL_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_hfltCoeff
int_hfltCoeff : bd_41e7_hsc_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_hfltCoeff_q1);
-- int_phasesH
int_phasesH : bd_41e7_hsc_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
entity bd_41e7_hsc_0_CTRL_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity bd_41e7_hsc_0_CTRL_s_axi_ram;

architecture behave of bd_41e7_hsc_0_CTRL_s_axi_ram is
