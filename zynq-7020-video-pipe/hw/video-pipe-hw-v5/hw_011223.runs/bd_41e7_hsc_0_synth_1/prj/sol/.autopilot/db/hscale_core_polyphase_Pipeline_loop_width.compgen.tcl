...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_upsampled_dout { I 30 vector } stream_upsampled_num_data_valid { I 5 vector } stream_upsampled_fifo_cap { I 5 vector } stream_upsampled_empty_n { I 1 bit } stream_upsampled_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_scaled_din { O 30 vector } stream_scaled_num_data_valid { I 5 vector } stream_scaled_fifo_cap { I 5 vector } stream_scaled_full_n { I 1 bit } stream_scaled_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_47_out_i { I 10 vector } PixArray_47_out_o { O 10 vector } PixArray_47_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_46_out_i { I 10 vector } PixArray_46_out_o { O 10 vector } PixArray_46_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_45_out_i { I 10 vector } PixArray_45_out_o { O 10 vector } PixArray_45_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_44_out_i { I 10 vector } PixArray_44_out_o { O 10 vector } PixArray_44_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_43_out_i { I 10 vector } PixArray_43_out_o { O 10 vector } PixArray_43_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_42_out_i { I 10 vector } PixArray_42_out_o { O 10 vector } PixArray_42_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_41_out_i { I 10 vector } PixArray_41_out_o { O 10 vector } PixArray_41_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_40_out_i { I 10 vector } PixArray_40_out_o { O 10 vector } PixArray_40_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_39_out_i { I 10 vector } PixArray_39_out_o { O 10 vector } PixArray_39_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_38_out_i { I 10 vector } PixArray_38_out_o { O 10 vector } PixArray_38_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_37_out_i { I 10 vector } PixArray_37_out_o { O 10 vector } PixArray_37_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_36_out_i { I 10 vector } PixArray_36_out_o { O 10 vector } PixArray_36_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_35_out_i { I 10 vector } PixArray_35_out_o { O 10 vector } PixArray_35_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_34_out_i { I 10 vector } PixArray_34_out_o { O 10 vector } PixArray_34_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_33_out_i { I 10 vector } PixArray_33_out_o { O 10 vector } PixArray_33_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_32_out_i { I 10 vector } PixArray_32_out_o { O 10 vector } PixArray_32_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_31_out_i { I 10 vector } PixArray_31_out_o { O 10 vector } PixArray_31_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_30_out_i { I 10 vector } PixArray_30_out_o { O 10 vector } PixArray_30_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_29_out_i { I 10 vector } PixArray_29_out_o { O 10 vector } PixArray_29_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_28_out_i { I 10 vector } PixArray_28_out_o { O 10 vector } PixArray_28_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_27_out_i { I 10 vector } PixArray_27_out_o { O 10 vector } PixArray_27_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_26_out_i { I 10 vector } PixArray_26_out_o { O 10 vector } PixArray_26_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_25_out_i { I 10 vector } PixArray_25_out_o { O 10 vector } PixArray_25_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { PixArray_24_out_i { I 10 vector } PixArray_24_out_o { O 10 vector } PixArray_24_out_o_ap_vld { O 1 bit } } \
} "
}
