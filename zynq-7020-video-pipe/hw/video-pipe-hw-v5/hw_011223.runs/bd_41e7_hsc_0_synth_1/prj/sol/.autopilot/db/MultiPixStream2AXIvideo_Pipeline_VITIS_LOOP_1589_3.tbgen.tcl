set moduleName MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1589_3
set isTopModule 0
...
set C_modelName {MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1589_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ sof int 1 regular  }
	{ empty_56 int 11 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "sof", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "empty_56", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_out_420_dout sc_in sc_lv 30 signal 3 } 
	...
	{ empty_56 sc_in sc_lv 11 signal 1 } 
	{ sub sc_in sc_lv 11 signal 2 } 
	{ empty_57 sc_in sc_lv 2 signal 4 } 
	{ empty_58 sc_in sc_lv 2 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_56", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "empty_56", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_7_2_10_1_1_U320", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_7_2_10_1_1_U321", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_7_2_10_1_1_U322", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "20", "Max" : "1924"}
	, {"Name" : "Interval", "Min" : "20", "Max" : "1924"}
]}
...
set Spec2ImplPortList { 
	...
	empty_56 { ap_stable {  { empty_56 in_data 0 11 } } }
