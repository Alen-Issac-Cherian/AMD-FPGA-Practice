...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler broncho_video_v_demosaic_0_0_DebayerRandBatG_lineBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
