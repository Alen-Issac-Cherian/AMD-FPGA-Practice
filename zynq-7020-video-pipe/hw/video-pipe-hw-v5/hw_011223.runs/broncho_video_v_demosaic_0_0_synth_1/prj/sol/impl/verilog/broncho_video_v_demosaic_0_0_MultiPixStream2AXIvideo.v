...
module broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [8:0] trunc_ln221_fu_124_p1;
reg   [8:0] trunc_ln221_reg_184;
reg    ap_block_state1;
wire   [8:0] empty_fu_128_p1;
reg   [8:0] empty_reg_189;
wire   [9:0] sub_i_i_fu_136_p2;
reg   [9:0] sub_i_i_reg_194;
...
reg   [8:0] i_fu_72;
wire   [8:0] i_2_fu_161_p2;
wire   [0:0] icmp_ln228_1_fu_156_p2;
wire   [9:0] empty_124_fu_132_p1;
...
broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2 grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign empty_124_fu_132_p1 = WidthOut[9:0];

assign empty_fu_128_p1 = WidthOut[8:0];
...
assign grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state4);

assign i_2_fu_161_p2 = (i_fu_72 + 9'd1);

assign icmp_ln228_1_fu_156_p2 = ((i_fu_72 == trunc_ln221_reg_184) ? 1'b1 : 1'b0);

assign icmp_ln228_fu_142_p2 = ((empty_fu_128_p1 == 9'd0) ? 1'b1 : 1'b0);
...
assign sub_i_i_fu_136_p2 = ($signed(empty_124_fu_132_p1) + $signed(10'd1023));

assign trunc_ln221_fu_124_p1 = Height[8:0];

endmodule //broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo
