...
entity broncho_video_v_demosaic_0_0_v_demosaic is
generic (
...
architecture behav of broncho_video_v_demosaic_0_0_v_demosaic is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "broncho_video_v_demosaic_0_0_v_demosaic,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.665000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=14,HLS_SYN_DSP=0,HLS_SYN_FF=12146,HLS_SYN_LUT=11045,HLS_VERSION=2023_2}";
    ...
    component broncho_video_v_demosaic_0_0_Block_entry1_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_AXIvideo2MultiBayer IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_Debayer IS
    port (
        ap_start : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_ZipperRemoval IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_fifo_w16_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_fifo_w10_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_fifo_w30_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_start_for_ZipperRemoval_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_CTRL_s_axi IS
    generic (
...
begin
    CTRL_s_axi_U : component broncho_video_v_demosaic_0_0_CTRL_s_axi
    generic map (
    ...
    Block_entry1_proc_U0 : component broncho_video_v_demosaic_0_0_Block_entry1_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    AXIvideo2MultiBayer_U0 : component broncho_video_v_demosaic_0_0_AXIvideo2MultiBayer
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Debayer_U0 : component broncho_video_v_demosaic_0_0_Debayer
    port map (
    ...
    ZipperRemoval_U0 : component broncho_video_v_demosaic_0_0_ZipperRemoval
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    MultiPixStream2AXIvideo_U0 : component broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    bayer_phase_assign_channel_U : component broncho_video_v_demosaic_0_0_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    imgBayer_U : component broncho_video_v_demosaic_0_0_fifo_w10_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    imgRgb_U : component broncho_video_v_demosaic_0_0_fifo_w30_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    imgUnzip_U : component broncho_video_v_demosaic_0_0_fifo_w30_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ZipperRemoval_U0_U : component broncho_video_v_demosaic_0_0_start_for_ZipperRemoval_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component broncho_video_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
