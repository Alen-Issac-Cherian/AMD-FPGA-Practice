...
entity broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln221_fu_124_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal trunc_ln221_reg_184 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal empty_fu_128_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal empty_reg_189 : STD_LOGIC_VECTOR (8 downto 0);
    signal sub_i_i_fu_136_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal sub_i_i_reg_194 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal i_2_fu_161_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal icmp_ln228_1_fu_156_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_124_fu_132_p1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    component broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100 : component broncho_video_v_demosaic_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    regslice_both_m_axis_video_V_data_V_U : component broncho_video_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_keep_V_U : component broncho_video_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_strb_V_U : component broncho_video_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_user_V_U : component broncho_video_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_last_V_U : component broncho_video_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_id_V_U : component broncho_video_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_dest_V_U : component broncho_video_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_block_state1, ap_CS_fsm_state2, grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_done, ap_CS_fsm_state4, icmp_ln228_1_fu_156_p2, ap_CS_fsm_state5, regslice_both_m_axis_video_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_done)
    begin
    ...
    empty_124_fu_132_p1 <= WidthOut(10 - 1 downto 0);
    empty_fu_128_p1 <= WidthOut(9 - 1 downto 0);
    ...
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state4);
    i_2_fu_161_p2 <= std_logic_vector(unsigned(i_fu_72) + unsigned(ap_const_lv9_1));
    icmp_ln228_1_fu_156_p2 <= "1" when (i_fu_72 = trunc_ln221_reg_184) else "0";
    icmp_ln228_fu_142_p2 <= "1" when (empty_fu_128_p1 = ap_const_lv9_0) else "0";

    imgUnzip_read_assign_proc : process(grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_imgUnzip_read, ap_CS_fsm_state4)
    begin
    ...
    sub_i_i_fu_136_p2 <= std_logic_vector(unsigned(empty_124_fu_132_p1) + unsigned(ap_const_lv10_3FF));
    trunc_ln221_fu_124_p1 <= Height(9 - 1 downto 0);
end behav;
