...
entity broncho_video_v_demosaic_0_0_Debayer is
port (
...
architecture behav of broncho_video_v_demosaic_0_0_Debayer is 
...
attribute shreg_extract : string;
    ...
    signal DebayerRatBorBatR_U0_height : STD_LOGIC_VECTOR (8 downto 0);
    signal DebayerRatBorBatR_U0_width : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal DebayerRandBatG_U0_height : STD_LOGIC_VECTOR (8 downto 0);
    signal DebayerRandBatG_U0_width : STD_LOGIC_VECTOR (8 downto 0);
    ...
    component broncho_video_v_demosaic_0_0_DebayerG IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_DebayerRatBorBatR IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_DebayerRandBatG IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_fifo_w30_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_start_for_DebayerRatBorBatR_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component broncho_video_v_demosaic_0_0_start_for_DebayerRandBatG_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    DebayerG_U0 : component broncho_video_v_demosaic_0_0_DebayerG
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    DebayerRatBorBatR_U0 : component broncho_video_v_demosaic_0_0_DebayerRatBorBatR
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    DebayerRandBatG_U0 : component broncho_video_v_demosaic_0_0_DebayerRandBatG
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    imgG_U : component broncho_video_v_demosaic_0_0_fifo_w30_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    bayerPhase_c9_U : component broncho_video_v_demosaic_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    imgRB_U : component broncho_video_v_demosaic_0_0_fifo_w30_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bayerPhase_c_U : component broncho_video_v_demosaic_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_DebayerRatBorBatR_U0_U : component broncho_video_v_demosaic_0_0_start_for_DebayerRatBorBatR_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_DebayerRandBatG_U0_U : component broncho_video_v_demosaic_0_0_start_for_DebayerRandBatG_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        ...
        vhi_cpy := (others => '0');
        vhi_cpy(4 - 1 downto 0) := ap_const_lv16_9(4 - 1 downto 0);
        v0_cpy := height;
        if (vlo_cpy(4 - 1 downto 0) > vhi_cpy(4 - 1 downto 0)) then
            vhi_cpy(4-1 downto 0) := std_logic_vector(16-1-unsigned(ap_const_lv16_9(4-1 downto 0)));
        ...
        DebayerRandBatG_U0_height <= resvalue(9-1 downto 0);
    end process;
    ...
    begin
        ...
        res_mask := res_mask(16-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        DebayerRandBatG_U0_width <= resvalue(9-1 downto 0);
    end process;
    ...
    begin
        ...
        res_mask := res_mask(16-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        DebayerRatBorBatR_U0_height <= resvalue(9-1 downto 0);
    end process;
    ...
    begin
        ...
        res_mask := res_mask(16-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        DebayerRatBorBatR_U0_width <= resvalue(9-1 downto 0);
    end process;
