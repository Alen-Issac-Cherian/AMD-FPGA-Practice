...
//--------------------------------------------------------------------------------
//Command: generate_target bd_41e7.bd
//Design : bd_41e7
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_41e7,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_41e7,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "broncho_video_v_proc_ss_0_1.hwdef" *) 
module bd_41e7
   (aclk_axis,
    aclk_ctrl,
    aresetn_ctrl,
  ...
  assign m_axis_tdata[31:0] = intf_net_hsc_m_axis_video_TDATA;
  assign m_axis_tdest[0] = intf_net_hsc_m_axis_video_TDEST;
  assign m_axis_tid[0] = intf_net_hsc_m_axis_video_TID;
  assign m_axis_tkeep[3:0] = intf_net_hsc_m_axis_video_TKEEP;
  assign m_axis_tlast[0] = intf_net_hsc_m_axis_video_TLAST;
  assign m_axis_tstrb[3:0] = intf_net_hsc_m_axis_video_TSTRB;
  ...
  bd_41e7_axis_register_slice_0_0 axis_register_slice_0
  ...
  bd_41e7_input_size_set_0 input_size_set
       (.aclk(net_bdry_in_aclk_axis),
        .aresetn(net_xlslice_1_Dout),
  ...
  bd_41e7_reset_sel_axis_0 reset_sel_axis
  ...
  bd_41e7_smartconnect_0_0 smartconnect_0
  ...
  bd_41e7_xlslice_0_0 xlslice_0
       (.Din(net_reset_sel_axis_gpio_io_i),
        .Dout(net_xlslice_0_Dout));
  bd_41e7_xlslice_1_0 xlslice_1
       (.Din(net_reset_sel_axis_gpio_io_i),
