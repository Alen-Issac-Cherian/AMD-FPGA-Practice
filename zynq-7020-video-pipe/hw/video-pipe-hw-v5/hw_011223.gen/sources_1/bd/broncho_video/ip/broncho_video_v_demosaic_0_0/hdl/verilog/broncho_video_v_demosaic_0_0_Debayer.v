...
module broncho_video_v_demosaic_0_0_Debayer (
        ap_start,
        start_full_n,
        start_out,
        start_write,
...
wire   [8:0] DebayerRatBorBatR_U0_height;
wire   [8:0] DebayerRatBorBatR_U0_width;
...
wire   [8:0] DebayerRandBatG_U0_height;
wire   [8:0] DebayerRandBatG_U0_width;
...
broncho_video_v_demosaic_0_0_DebayerG DebayerG_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
broncho_video_v_demosaic_0_0_DebayerRatBorBatR DebayerRatBorBatR_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
broncho_video_v_demosaic_0_0_DebayerRandBatG DebayerRandBatG_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
broncho_video_v_demosaic_0_0_fifo_w30_d2_S imgG_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
broncho_video_v_demosaic_0_0_fifo_w16_d2_S bayerPhase_c9_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
broncho_video_v_demosaic_0_0_fifo_w30_d2_S imgRB_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
broncho_video_v_demosaic_0_0_fifo_w16_d2_S bayerPhase_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
broncho_video_v_demosaic_0_0_start_for_DebayerRatBorBatR_U0 start_for_DebayerRatBorBatR_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
broncho_video_v_demosaic_0_0_start_for_DebayerRandBatG_U0 start_for_DebayerRandBatG_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign DebayerRandBatG_U0_height = {{height[(9 - 16'd1):0]}};

assign DebayerRandBatG_U0_width = {{width[(9 - 16'd1):0]}};

assign DebayerRatBorBatR_U0_ap_continue = 1'b1;

assign DebayerRatBorBatR_U0_ap_start = start_for_DebayerRatBorBatR_U0_empty_n;

assign DebayerRatBorBatR_U0_height = {{height[(9 - 16'd1):0]}};

assign DebayerRatBorBatR_U0_width = {{width[(9 - 16'd1):0]}};
...
endmodule //broncho_video_v_demosaic_0_0_Debayer
