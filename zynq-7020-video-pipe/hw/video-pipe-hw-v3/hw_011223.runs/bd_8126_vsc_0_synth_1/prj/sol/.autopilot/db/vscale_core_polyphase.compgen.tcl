...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_8126_vsc_0_vscale_core_polyphase_FiltCoeff_RAM_1P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_1p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_8126_vsc_0_vscale_core_polyphase_LineBuf_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
