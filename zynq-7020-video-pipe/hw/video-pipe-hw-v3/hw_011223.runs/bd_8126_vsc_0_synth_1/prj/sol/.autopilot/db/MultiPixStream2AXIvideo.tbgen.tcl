...
set Spec2ImplPortList { 
	OutYUV { ap_fifo {  { OutYUV_dout fifo_data_in 0 24 }  { OutYUV_num_data_valid fifo_status_num_data_valid 0 5 }  { OutYUV_fifo_cap fifo_update 0 5 }  { OutYUV_empty_n fifo_status 0 1 }  { OutYUV_read fifo_port_we 1 1 } } }
