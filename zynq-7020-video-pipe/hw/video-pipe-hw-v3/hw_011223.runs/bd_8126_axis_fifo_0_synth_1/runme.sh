...
HD_PWD='G:/Project-Workspace/zynq-7020-video-pipe-3/hw/video-pipe-hw-v3/hw_011223.runs/bd_8126_axis_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_8126_axis_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_8126_axis_fifo_0.tcl
