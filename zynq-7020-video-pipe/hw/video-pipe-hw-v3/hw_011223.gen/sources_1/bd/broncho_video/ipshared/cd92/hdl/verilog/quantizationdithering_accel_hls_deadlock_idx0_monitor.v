...
module quantizationdithering_accel_hls_deadlock_idx0_monitor ( // for module quantizationdithering_accel_quantizationdithering_accel_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 quantizationdithering_accel_hls_deadlock_idx1_monitor quantizationdithering_accel_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
