...
HD_PWD='G:/Project-Workspace/zynq-7020-video-pipe-3/hw/video-pipe-hw-v0/hw_011223.runs/broncho_video_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log broncho_video_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source broncho_video_vio_0_0.tcl
