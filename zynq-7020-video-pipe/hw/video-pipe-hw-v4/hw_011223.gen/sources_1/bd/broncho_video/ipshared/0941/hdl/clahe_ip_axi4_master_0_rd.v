// -------------------------------------------------------------
// 
// File Name: d:\soc_prj\hdlcoder\CLAHE\hdlsrc\CLAHEAlgorithm_fpga\clahe_ip_axi4_master_0_rd.v
...
// -------------------------------------------------------------
// 
// Module: clahe_ip_axi4_master_0_rd
// Source Path: clahe_ip/clahe_ip_axi4_master_0_rd
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module clahe_ip_axi4_master_0_rd
  ...
  input   [31:0] user_rd_len;  // ufix32
  input   user_rd_avalid;  // ufix1
  input   user_rd_dready;  // ufix1
  input   [31:0] write_AXI4_Master_0_Rd_base_address;  // ufix32
  ...
  output  in_burst_axi4_master_0_rd;  // ufix1
  ...
  wire [31:0] rd_fifo_len;  // ufix32
  reg [7:0] axi4_master_rd_rd_state;  // uint8
  reg [31:0] axi4_master_rd_rd_len;  // ufix32
  ...
  reg [31:0] axi4_master_rd_rd_len_next;  // ufix32
  ...
  reg  AXI4_Master_0_Rd_ARVALID_1;  // ufix1
  reg [31:0] AXI4_Master_0_Rd_ARADDR_1;  // ufix32
  reg [7:0] AXI4_Master_0_Rd_ARLEN_1;  // ufix8
  reg  AXI4_Master_0_Rd_ARID_1;  // ufix1
  wire [2:0] const_arsize;  // ufix3
  wire [1:0] const_1_2;  // ufix2
  wire const_0_1;  // ufix1
  wire [3:0] const_3_4;  // ufix4
  wire [2:0] const_0_3;  // ufix3
  reg  rd_dready_reg;  // ufix1
  ...
  assign full_addr = user_rd_addr + write_AXI4_Master_0_Rd_base_address;
  ...
  clahe_ip_rd_addr_fifo u_clahe_ip_rd_addr_fifo_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(const_1_1),
                                                      .In(full_addr),  // ufix32
  ...
  clahe_ip_rd_len_fifo u_clahe_ip_rd_len_fifo_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(const_1_1),
                                                    .In(len_val),  // ufix32
                                                    .Push(user_rd_avalid),  // ufix1
                                                    .Pop(rd_fifo_ack),  // ufix1
                                                    .Out(rd_fifo_len)  // ufix32
                                                    );
  ...
  always @(posedge clk)
    begin : axi4_master_rd_process
      if (reset == 1'b1) begin
        ...
        axi4_master_rd_rd_len <= 32'b00000000000000000000000000000000;
  ...
  always @(AXI4_Master_0_Rd_ARREADY, axi4_master_rd_araddr_reg, axi4_master_rd_arlen_reg,
    ...
    case ( axi4_master_rd_rd_state)
      ...
      8'd1 :
        begin
          if (AXI4_Master_0_Rd_ARREADY && axi4_master_rd_arvalid_reg) begin
            axi4_master_rd_arvalid_reg_next = 1'b0;
          ...
          if (axi4_master_rd_rd_len > 32'b00000000000000000000000011111111) begin
            axi4_master_rd_arlen_reg_next = 8'b11111111;
            axi4_master_rd_last_burst_next = 1'b0;
          end
          else begin
            axi4_master_rd_arlen_reg_next = axi4_master_rd_rd_len[7:0];
            axi4_master_rd_last_burst_next = 1'b1;
          end
        end
      8'd2 :
        begin
          axi4_master_rd_rd_len_next = axi4_master_rd_rd_len - 32'b00000000000000000000000100000000;
    ...
    endcase
    AXI4_Master_0_Rd_ARVALID_1 = axi4_master_rd_arvalid_reg;
    AXI4_Master_0_Rd_ARADDR_1 = axi4_master_rd_araddr_reg;
    AXI4_Master_0_Rd_ARLEN_1 = axi4_master_rd_arlen_reg;
    AXI4_Master_0_Rd_ARID_1 = axi4_master_rd_rd_arid_reg;
  end
  ...
  assign AXI4_Master_0_Rd_ARSIZE = const_arsize;

  assign const_1_2 = 2'b01;



  assign AXI4_Master_0_Rd_ARBURST = const_1_2;

  assign const_0_1 = 1'b0;



  assign AXI4_Master_0_Rd_ARLOCK = const_0_1;

  assign const_3_4 = 4'b0011;



  assign AXI4_Master_0_Rd_ARCACHE = const_3_4;

  assign const_0_3 = 3'b000;



  assign AXI4_Master_0_Rd_ARPROT = const_0_3;

  always @(posedge clk)
    begin : rdy_reg_comp_process
      if (reset == 1'b1) begin
        rd_dready_reg <= 1'b0;
      end
      else begin
  ...
  clahe_ip_rdata_fifo u_clahe_ip_rdata_fifo_inst (.clk(clk),
                                                  .reset(reset),
                                                  .enb(const_1_1),
                                                  .In(AXI4_Master_0_Rd_RDATA),  // ufix32
                                                  .Push(AXI4_Master_0_Rd_RVALID),  // ufix1
  ...
  assign AXI4_Master_0_Rd_RREADY =  ~ rdata_fifo_full;
  ...
  assign rd_dvalid = rdata_fifo_valid & rd_dready_reg;



  assign user_rd_dvalid = rd_dvalid;

  assign ar_transfer = AXI4_Master_0_Rd_ARREADY & AXI4_Master_0_Rd_ARVALID_1;
  ...
  assign arlen_adder_1 = {1'b0, AXI4_Master_0_Rd_ARLEN_1};
  ...
  assign r_transfer = AXI4_Master_0_Rd_RREADY & AXI4_Master_0_Rd_RVALID;
  ...
  assign in_burst_axi4_master_0_rd = accum_value > 32'sb00000000000000000000000000000000;



  assign AXI4_Master_0_Rd_ARID = AXI4_Master_0_Rd_ARID_1;

  assign AXI4_Master_0_Rd_ARADDR = AXI4_Master_0_Rd_ARADDR_1;

  assign AXI4_Master_0_Rd_ARLEN = AXI4_Master_0_Rd_ARLEN_1;

  assign AXI4_Master_0_Rd_ARVALID = AXI4_Master_0_Rd_ARVALID_1;

endmodule  // clahe_ip_axi4_master_0_rd
