// -------------------------------------------------------------
// 
// File Name: d:\soc_prj\hdlcoder\CLAHE\hdlsrc\CLAHEAlgorithm_fpga\clahe_ip_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: clahe_ip_fifo_data_OUT
// Source Path: clahe_ip/clahe_ip_axi4_stream_video_0_master/clahe_ip_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module clahe_ip_fifo_data_OUT
  ...
  clahe_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                       .DataWidth(16)
                                       )
                                     u_clahe_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                   .enb(enb),
                                                                                   .wr_din(In),
                                                                                   .wr_addr(w_waddr),
                                                                                   .wr_en(w_we),  // ufix1
...
endmodule  // clahe_ip_fifo_data_OUT
