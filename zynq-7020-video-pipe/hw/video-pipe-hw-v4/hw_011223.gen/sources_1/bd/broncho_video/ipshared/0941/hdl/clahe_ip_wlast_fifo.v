// -------------------------------------------------------------
// 
// File Name: d:\soc_prj\hdlcoder\CLAHE\hdlsrc\CLAHEAlgorithm_fpga\clahe_ip_wlast_fifo.v
...
// -------------------------------------------------------------
// 
// Module: clahe_ip_wlast_fifo
// Source Path: clahe_ip/clahe_ip_axi4_master_0_wr/clahe_ip_wlast_fifo
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module clahe_ip_wlast_fifo
  ...
  clahe_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(3),
                                         .DataWidth(1)
                                         )
                                       u_clahe_ip_wlast_fifo_classic_ram (.clk(clk),
                                                                          .enb(enb),
                                                                          .wr_din(In),  // ufix1
                                                                          .wr_addr(w_waddr),
                                                                          .wr_en(w_we),  // ufix1
