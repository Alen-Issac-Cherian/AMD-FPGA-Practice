// -------------------------------------------------------------
// 
// File Name: d:\soc_prj\hdlcoder\CLAHE\hdlsrc\CLAHEAlgorithm_fpga\clahe_ip_axi4_master_0_wr.v
...
// -------------------------------------------------------------
// 
// Module: clahe_ip_axi4_master_0_wr
// Source Path: clahe_ip/clahe_ip_axi4_master_0_wr
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module clahe_ip_axi4_master_0_wr
  ...
  input   [31:0] user_wr_len;  // ufix32
  input   user_wr_valid;  // ufix1
  input   [31:0] write_AXI4_Master_0_Wr_base_address;  // ufix32
  ...
  output  user_wr_bvalid;  // ufix1
  output  user_wr_complete;  // ufix1
  output  in_burst_axi4_master_0_wr;  // ufix1


  wire enb;
  wire const_len_dec;  // ufix1
  wire signed [32:0] len_decrement_sub_temp;  // sfix33
  wire signed [32:0] len_decrement_1;  // sfix33
  wire [31:0] len_decrement_2;  // ufix32
  wire signed [32:0] len_decrement_3;  // sfix33
  wire [31:0] len_val;  // ufix32
  ...
  reg [31:0] axi4_master_wr_wr_len_reg_next;  // ufix32
  ...
  reg  AXI4_Master_0_Wr_AWVALID_1;  // ufix1
  reg [31:0] AXI4_Master_0_Wr_AWADDR_1;  // ufix32
  reg [7:0] AXI4_Master_0_Wr_AWLEN_1;  // ufix8
  reg  AXI4_Master_0_Wr_AWID_1;  // ufix1
  ...
  assign len_decrement_2 = {31'b0, const_len_dec};
  assign len_decrement_3 = {1'b0, len_decrement_2};
  assign len_decrement_sub_temp = len_decrement_1 - len_decrement_3;
  assign len_val = (len_decrement_sub_temp[32] == 1'b1 ? 32'b00000000000000000000000000000000 :
              len_decrement_sub_temp[31:0]);
  ...
  assign full_addr = user_wr_addr + write_AXI4_Master_0_Wr_base_address;
  ...
  assign out_fifo_ack = AXI4_Master_0_Wr_WREADY & wvalid_internal;
  ...
  clahe_ip_wdata_fifo u_clahe_ip_wdata_fifo_inst (.clk(clk),
                                                  .reset(reset),
                                                  .enb(const_1_1),
                                                  .In(out_fifo_wdata),  // ufix32
                                                  .Push(out_fifo_push),  // ufix1
                                                  .Pop(out_fifo_ack),  // ufix1
                                                  .Out(AXI4_Master_0_Wr_WDATA),  // ufix32
                                                  .Empty(out_fifo_empty),  // ufix1
                                                  .AFull(out_fifo_afull)  // ufix1
                                                  );

  clahe_ip_wr_addr_fifo u_clahe_ip_wr_addr_fifo_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(const_1_1),
                                                      .In(full_addr),  // ufix32
  ...
  clahe_ip_wr_data_fifo u_clahe_ip_wr_data_fifo_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(const_1_1),
                                                      .In(user_data),  // ufix32
                                                      .Push(user_wr_valid),  // ufix1
  ...
  clahe_ip_wr_len_fifo u_clahe_ip_wr_len_fifo_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(const_1_1),
                                                    .In(len_val),  // ufix32
                                                    .Push(user_wr_valid),  // ufix1
                                                    .Pop(wr_fifo_ack),  // ufix1
                                                    .Out(wr_fifo_len)  // ufix32
                                                    );
  ...
  always @(posedge clk)
    begin : axi4_master_wr_process
      if (reset == 1'b1) begin
        ...
        axi4_master_wr_wr_len_reg <= 32'b00000000000000000000000000000000;
  ...
  always @(AXI4_Master_0_Wr_AWREADY, axi4_master_wr_addr_done_reg,
    ...
    case ( axi4_master_wr_wr_astate)
      ...
      8'd1 :
        begin
          axi4_master_wr_addr_done_reg_temp = 1'b0;
          if (axi4_master_wr_awvalid_reg && AXI4_Master_0_Wr_AWREADY) begin
          ...
          if (axi4_master_wr_wr_len_reg > 32'b00000000000000000000000011111111) begin
            axi4_master_wr_awlen_reg_next = 8'b11111111;
            axi4_master_wr_last_burst_reg_temp = 1'b0;
          end
          else begin
            axi4_master_wr_awlen_reg_next = axi4_master_wr_wr_len_reg[7:0];
      ...
      8'd3 :
        begin
          if (axi4_master_wr_data_done_reg) begin
            ...
            axi4_master_wr_wr_len_reg_next = axi4_master_wr_wr_len_reg - 32'b00000000000000000000000100000000;
    ...
    case ( axi4_master_wr_wr_dstate)
      ...
      8'd1 :
        begin
          ...
          axi4_master_wr_data_done_reg_next = 1'b0;
          if (axi4_master_wr_wr_len_reg > 32'b00000000000000000000000011111111) begin
            axi4_master_wr_burst_cnt_reg_next = 8'b11111111;
          end
          else begin
            axi4_master_wr_burst_cnt_reg_next = axi4_master_wr_wr_len_reg[7:0];
          end
          wr_fifo_ack = 1'b0;
          wr_transfer = 1'b0;
        end
    ...
    endcase
    AXI4_Master_0_Wr_AWVALID_1 = axi4_master_wr_awvalid_reg;
    AXI4_Master_0_Wr_AWADDR_1 = axi4_master_wr_awaddr_reg;
    AXI4_Master_0_Wr_AWLEN_1 = axi4_master_wr_awlen_reg;
    AXI4_Master_0_Wr_AWID_1 = axi4_master_wr_awid_reg;
  ...
  assign AXI4_Master_0_Wr_AWSIZE = const_awsize;

  assign const_1_2 = 2'b01;



  assign AXI4_Master_0_Wr_AWBURST = const_1_2;

  assign const_0_1 = 1'b0;



  assign AXI4_Master_0_Wr_AWLOCK = const_0_1;

  assign const_3_4 = 4'b0011;



  assign AXI4_Master_0_Wr_AWCACHE = const_3_4;

  assign const_0_3 = 3'b000;



  assign AXI4_Master_0_Wr_AWPROT = const_0_3;

  assign const_wstrb = 4'b1111;



  assign AXI4_Master_0_Wr_WSTRB = const_wstrb;

  clahe_ip_wlast_fifo u_clahe_ip_wlast_fifo_inst (.clk(clk),
                                                  .reset(reset),
                                                  .enb(const_1_1),
                                                  .In(out_fifo_wlast),  // ufix1
                                                  .Push(out_fifo_push),  // ufix1
                                                  .Pop(out_fifo_ack),  // ufix1
                                                  .Out(AXI4_Master_0_Wr_WLAST)  // ufix1
                                                  );

  assign AXI4_Master_0_Wr_WVALID = wvalid_internal;

  assign AXI4_Master_0_Wr_BREADY = const_1_1;

  assign user_wr_ready =  ~ wr_fifo_afull;



  assign user_wr_bvalid = AXI4_Master_0_Wr_BVALID;

  assign user_wr_complete = wr_complete_internal;

  assign aw_transfer = AXI4_Master_0_Wr_AWREADY & AXI4_Master_0_Wr_AWVALID_1;
  ...
  assign w_transfer = const_1_1 & AXI4_Master_0_Wr_BVALID;
  ...
  assign in_burst_axi4_master_0_wr = accum_value > 32'sb00000000000000000000000000000000;



  assign AXI4_Master_0_Wr_AWID = AXI4_Master_0_Wr_AWID_1;

  assign AXI4_Master_0_Wr_AWADDR = AXI4_Master_0_Wr_AWADDR_1;

  assign AXI4_Master_0_Wr_AWLEN = AXI4_Master_0_Wr_AWLEN_1;

  assign AXI4_Master_0_Wr_AWVALID = AXI4_Master_0_Wr_AWVALID_1;

endmodule  // clahe_ip_axi4_master_0_wr
