...
module bd_4177_csc_0_MultiPixStream2AXIvideo (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [8:0] grp_reg_unsigned_short_s_fu_145_ap_return;
reg   [8:0] rows_reg_199;
wire   [8:0] grp_reg_unsigned_short_s_fu_151_ap_return;
reg   [8:0] cols_reg_204;
wire   [8:0] sub_fu_162_p2;
reg   [8:0] sub_reg_209;
...
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_stream_out_vresampled_read;
...
bd_4177_csc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2 grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
bd_4177_csc_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_145(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .d(Height_dout),
...
bd_4177_csc_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_151(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .d(WidthOut_dout),
...
always @ (posedge ap_clk) begin
    if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        sof_reg_106 <= 1'd0;
...
assign grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state5);

assign i_2_fu_176_p2 = (i_fu_84 + 9'd1);
...
assign sub_fu_162_p2 = ($signed(grp_reg_unsigned_short_s_fu_151_ap_return) + $signed(9'd511));

endmodule //bd_4177_csc_0_MultiPixStream2AXIvideo
