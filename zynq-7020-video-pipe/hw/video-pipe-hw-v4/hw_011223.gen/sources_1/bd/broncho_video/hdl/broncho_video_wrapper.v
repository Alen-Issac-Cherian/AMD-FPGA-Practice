...
//Command     : generate_target broncho_video_wrapper.bd
//Design      : broncho_video_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module broncho_video_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  wire IIC_1_0_sda_o;
  wire IIC_1_0_sda_t;
  wire [0:0]ov426_resetn;
  wire sys_diff_clock_clk_n;
  wire sys_diff_clock_clk_p;
  wire vid_active_video;
  wire vid_active_video_in;
  wire vid_clk;
  wire [15:0]vid_data;
  wire [9:0]vid_data_in;
  wire vid_hsync;
  wire vid_io_in_clk;
  wire vid_locked;
  wire vid_vsync;
