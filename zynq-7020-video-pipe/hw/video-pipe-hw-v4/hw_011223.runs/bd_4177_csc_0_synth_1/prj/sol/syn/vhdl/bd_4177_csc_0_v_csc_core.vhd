...
entity bd_4177_csc_0_v_csc_core is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of bd_4177_csc_0_v_csc_core is 
...
attribute shreg_extract : string;
    ...
    signal offsetR_fu_233_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal offsetR_reg_365 : STD_LOGIC_VECTOR (21 downto 0);
    signal offsetG_fu_241_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal offsetG_reg_370 : STD_LOGIC_VECTOR (21 downto 0);
    signal offsetB_fu_249_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal offsetB_reg_375 : STD_LOGIC_VECTOR (21 downto 0);
    signal add_ln134_fu_261_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln134_reg_380 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln134_1_fu_271_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln134_1_reg_385 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208_stream_in_hresampled_read : STD_LOGIC;
    ...
    signal y_8_fu_290_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal loopWidth_cast_fu_257_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal height_load_cast_fu_267_p1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    component bd_4177_csc_0_v_csc_core_Pipeline_VITIS_LOOP_136_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208 : component bd_4177_csc_0_v_csc_core_Pipeline_VITIS_LOOP_136_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        stream_in_hresampled_read => grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208_stream_in_hresampled_read,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                ...
                add_ln134_reg_380 <= add_ln134_fu_261_p2;
                    offsetB_reg_375(21 downto 12) <= offsetB_fu_249_p3(21 downto 12);
                    offsetG_reg_370(21 downto 12) <= offsetG_fu_241_p3(21 downto 12);
                    offsetR_reg_365(21 downto 12) <= offsetR_fu_233_p3(21 downto 12);
            end if;
        end if;
    end process;
    offsetR_reg_365(11 downto 0) <= "000000000000";
    offsetG_reg_370(11 downto 0) <= "000000000000";
    offsetB_reg_375(11 downto 0) <= "000000000000";
    ...
    HwReg_height_c26_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    HwReg_width_c20_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    add_ln134_1_fu_271_p2 <= std_logic_vector(unsigned(height_load_cast_fu_267_p1) + unsigned(ap_const_lv10_1));
    add_ln134_fu_261_p2 <= std_logic_vector(unsigned(loopWidth_cast_fu_257_p1) + unsigned(ap_const_lv10_1));
    ...
    height_load_cast_fu_267_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(height_dout),10));
    ...
    loopWidth_cast_fu_257_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(width_dout),10));
    offsetB_fu_249_p3 <= (BOffset_read & ap_const_lv12_0);
    offsetG_fu_241_p3 <= (GOffset_read & ap_const_lv12_0);
    offsetR_fu_233_p3 <= (ROffset_read & ap_const_lv12_0);
    stream_csc_din <= grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208_stream_csc_din;
    ...
    stream_in_hresampled_read_assign_proc : process(grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208_stream_in_hresampled_read, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            stream_in_hresampled_read <= grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208_stream_in_hresampled_read;
        else 
    ...
    y_8_fu_290_p2 <= std_logic_vector(unsigned(y_fu_92) + unsigned(ap_const_lv10_1));
end behav;
