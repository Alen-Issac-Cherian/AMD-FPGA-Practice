...
module bd_4177_csc_0_Block_entry3_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [8:0] HwReg_width_1_fu_162_p1;
wire   [8:0] HwReg_height_1_fu_166_p1;
...
assign HwReg_height_1_fu_166_p1 = height[8:0];

assign HwReg_width_1_fu_162_p1 = width[8:0];
...
endmodule //bd_4177_csc_0_Block_entry3_proc
