...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_Height \
    op interface \
    ports { Height_dout { I 9 vector } Height_num_data_valid { I 3 vector } Height_fifo_cap { I 3 vector } Height_empty_n { I 1 bit } Height_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthOut_dout { I 9 vector } WidthOut_num_data_valid { I 3 vector } WidthOut_fifo_cap { I 3 vector } WidthOut_empty_n { I 1 bit } WidthOut_read { O 1 bit } } \
} "
}
