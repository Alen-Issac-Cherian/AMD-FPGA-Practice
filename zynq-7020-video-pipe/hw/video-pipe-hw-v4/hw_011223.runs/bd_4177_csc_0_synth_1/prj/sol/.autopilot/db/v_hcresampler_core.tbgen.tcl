...
set C_modelArgList {
	...
	{ HwReg_width_c19 int 9 regular {fifo 1}  }
	{ HwReg_height_c25 int 9 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_csc", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_width_c19", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c25", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ HwReg_width_c19_din sc_out sc_lv 9 signal 5 } 
	{ HwReg_width_c19_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c19_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c19_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_width_c19_write sc_out sc_logic 1 signal 5 } 
	{ HwReg_height_c25_din sc_out sc_lv 9 signal 6 } 
	{ HwReg_height_c25_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ HwReg_height_c25_fifo_cap sc_in sc_lv 3 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_width_c19_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_width_c19", "role": "din" }} , 
 	{ "name": "HwReg_width_c19_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c19", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_c19_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c19", "role": "fifo_cap" }} , 
 	...
 	{ "name": "HwReg_height_c25_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_height_c25", "role": "din" }} , 
 	{ "name": "HwReg_height_c25_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c25", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_c25_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c25", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "stream_csc", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_hcresampler_core_Pipeline_VITIS_LOOP_769_2_fu_196", "Port" : "stream_csc", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "stream_out_hresampled", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_hcresampler_core_Pipeline_VITIS_LOOP_769_2_fu_196", "Port" : "stream_out_hresampled", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_769_2_fu_196", "Parent" : "0", "Child" : ["2", "3"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_769_2_fu_196.sparsemux_9_2_8_1_1_U185", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_769_2_fu_196.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "1073971193"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "1073971193"}
]}
...
set Spec2ImplPortList { 
	...
	HwReg_width_c19 { ap_fifo {  { HwReg_width_c19_din fifo_data_in 1 9 }  { HwReg_width_c19_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_c19_fifo_cap fifo_update 0 3 }  { HwReg_width_c19_full_n fifo_status 0 1 }  { HwReg_width_c19_write fifo_port_we 1 1 } } }
	HwReg_height_c25 { ap_fifo {  { HwReg_height_c25_din fifo_data_in 1 9 }  { HwReg_height_c25_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_c25_fifo_cap fifo_update 0 3 }  { HwReg_height_c25_full_n fifo_status 0 1 }  { HwReg_height_c25_write fifo_port_we 1 1 } } }
}
