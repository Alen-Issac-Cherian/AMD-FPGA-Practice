...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_width_c23_din { O 9 vector } HwReg_width_c23_num_data_valid { I 3 vector } HwReg_width_c23_fifo_cap { I 3 vector } HwReg_width_c23_full_n { I 1 bit } HwReg_width_c23_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_height_c29_din { O 9 vector } HwReg_height_c29_num_data_valid { I 3 vector } HwReg_height_c29_fifo_cap { I 3 vector } HwReg_height_c29_full_n { I 1 bit } HwReg_height_c29_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 67
set RegSliceName bd_4177_csc_0_regslice_both
set RegSliceInstName bd_4177_csc_0_regslice_both_U
set CoreName ap_simcore_bd_4177_csc_0_regslice_both
