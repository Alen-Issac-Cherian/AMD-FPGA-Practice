...
set C_modelArgList {
	...
	{ HwReg_width_c22 int 9 regular {fifo 1}  }
	{ HwReg_height_c28 int 9 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_in", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_width_c22", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c28", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ HwReg_width_c22_din sc_out sc_lv 9 signal 5 } 
	{ HwReg_width_c22_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c22_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c22_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_width_c22_write sc_out sc_logic 1 signal 5 } 
	{ HwReg_height_c28_din sc_out sc_lv 9 signal 6 } 
	{ HwReg_height_c28_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ HwReg_height_c28_fifo_cap sc_in sc_lv 3 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_width_c22_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_width_c22", "role": "din" }} , 
 	{ "name": "HwReg_width_c22_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c22", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_c22_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c22", "role": "fifo_cap" }} , 
 	...
 	{ "name": "HwReg_height_c28_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_height_c28", "role": "din" }} , 
 	{ "name": "HwReg_height_c28_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c28", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_c28_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c28", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			{"Name" : "stream_in", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_v_vcresampler_core_1_Pipeline_VITIS_LOOP_1000_2_fu_146", "Port" : "stream_in", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "stream_in_vresampled", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_v_vcresampler_core_1_Pipeline_VITIS_LOOP_1000_2_fu_146", "Port" : "stream_in_vresampled", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_vcresampler_core_1_Pipeline_VITIS_LOOP_1000_2_fu_146", "Parent" : "0", "Child" : ["6"],
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_vcresampler_core_1_Pipeline_VITIS_LOOP_1000_2_fu_146.flow_control_loop_pipe_sequential_init_U", "Parent" : "5"}]}
...
set Spec2ImplPortList { 
	...
	HwReg_width_c22 { ap_fifo {  { HwReg_width_c22_din fifo_data_in 1 9 }  { HwReg_width_c22_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_c22_fifo_cap fifo_update 0 3 }  { HwReg_width_c22_full_n fifo_status 0 1 }  { HwReg_width_c22_write fifo_port_we 1 1 } } }
	HwReg_height_c28 { ap_fifo {  { HwReg_height_c28_din fifo_data_in 1 9 }  { HwReg_height_c28_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_c28_fifo_cap fifo_update 0 3 }  { HwReg_height_c28_full_n fifo_status 0 1 }  { HwReg_height_c28_write fifo_port_we 1 1 } } }
}
