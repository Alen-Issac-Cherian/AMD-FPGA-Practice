...
set C_modelArgList {
	...
	{ HwReg_width_c23 int 9 regular {fifo 1}  }
	{ HwReg_height_c29 int 9 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_video_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_width_c23", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c29", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ HwReg_width_c23_din sc_out sc_lv 9 signal 11 } 
	{ HwReg_width_c23_num_data_valid sc_in sc_lv 3 signal 11 } 
	{ HwReg_width_c23_fifo_cap sc_in sc_lv 3 signal 11 } 
	{ HwReg_width_c23_full_n sc_in sc_logic 1 signal 11 } 
	{ HwReg_width_c23_write sc_out sc_logic 1 signal 11 } 
	{ HwReg_height_c29_din sc_out sc_lv 9 signal 12 } 
	{ HwReg_height_c29_num_data_valid sc_in sc_lv 3 signal 12 } 
	{ HwReg_height_c29_fifo_cap sc_in sc_lv 3 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_width_c23_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_width_c23", "role": "din" }} , 
 	{ "name": "HwReg_width_c23_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c23", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_c23_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c23", "role": "fifo_cap" }} , 
 	...
 	{ "name": "HwReg_height_c29_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_height_c29", "role": "din" }} , 
 	{ "name": "HwReg_height_c29_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c29", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_c29_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c29", "role": "fifo_cap" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4742", "Max" : "164006"}
	, {"Name" : "Interval", "Min" : "4742", "Max" : "164006"}
]}
...
set Spec2ImplPortList { 
	...
	HwReg_width_c23 { ap_fifo {  { HwReg_width_c23_din fifo_data_in 1 9 }  { HwReg_width_c23_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_c23_fifo_cap fifo_update 0 3 }  { HwReg_width_c23_full_n fifo_status 0 1 }  { HwReg_width_c23_write fifo_port_we 1 1 } } }
	HwReg_height_c29 { ap_fifo {  { HwReg_height_c29_din fifo_data_in 1 9 }  { HwReg_height_c29_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_c29_fifo_cap fifo_update 0 3 }  { HwReg_height_c29_full_n fifo_status 0 1 }  { HwReg_height_c29_write fifo_port_we 1 1 } } }
}
