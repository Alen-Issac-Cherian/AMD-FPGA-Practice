...
set C_modelArgList {
	...
	{ HwReg_width_c int 9 regular {fifo 1}  }
	{ HwReg_height_c int 9 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_out_hresampled", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_width_c", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ HwReg_width_c_din sc_out sc_lv 9 signal 5 } 
	{ HwReg_width_c_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_width_c_write sc_out sc_logic 1 signal 5 } 
	{ HwReg_height_c_din sc_out sc_lv 9 signal 6 } 
	{ HwReg_height_c_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ HwReg_height_c_fifo_cap sc_in sc_lv 3 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_width_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_width_c", "role": "din" }} , 
 	...
 	{ "name": "HwReg_height_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_height_c", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			{"Name" : "stream_out_hresampled", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1000_2_fu_138", "Port" : "stream_out_hresampled", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			...
			{"Name" : "stream_out_vresampled", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1000_2_fu_138", "Port" : "stream_out_vresampled", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1000_2_fu_138", "Parent" : "0", "Child" : ["5"],
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1000_2_fu_138.flow_control_loop_pipe_sequential_init_U", "Parent" : "4"}]}
...
set Spec2ImplPortList { 
	...
	HwReg_width_c { ap_fifo {  { HwReg_width_c_din fifo_data_in 1 9 }  { HwReg_width_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_c_fifo_cap fifo_update 0 3 }  { HwReg_width_c_full_n fifo_status 0 1 }  { HwReg_width_c_write fifo_port_we 1 1 } } }
	HwReg_height_c { ap_fifo {  { HwReg_height_c_din fifo_data_in 1 9 }  { HwReg_height_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_c_fifo_cap fifo_update 0 3 }  { HwReg_height_c_full_n fifo_status 0 1 }  { HwReg_height_c_write fifo_port_we 1 1 } } }
}
