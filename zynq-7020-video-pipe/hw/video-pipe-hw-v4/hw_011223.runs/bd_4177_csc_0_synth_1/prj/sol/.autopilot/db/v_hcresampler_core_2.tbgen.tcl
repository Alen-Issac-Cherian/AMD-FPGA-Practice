...
set C_modelArgList {
	...
	{ HwReg_height int 9 regular {fifo 0}  }
	{ HwReg_width int 9 regular {fifo 0}  }
	{ p_read int 1 regular  }
	{ stream_in_hresampled int 24 regular {fifo 1 volatile }  }
	{ HwReg_width_c21 int 9 regular {fifo 1}  }
	{ HwReg_height_c27 int 9 regular {fifo 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "stream_in_vresampled", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "HwReg_height", "interface" : "fifo", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "HwReg_width", "interface" : "fifo", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "stream_in_hresampled", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_width_c21", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c27", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ HwReg_height_dout sc_in sc_lv 9 signal 1 } 
	{ HwReg_height_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ HwReg_height_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ HwReg_height_empty_n sc_in sc_logic 1 signal 1 } 
	{ HwReg_height_read sc_out sc_logic 1 signal 1 } 
	{ HwReg_width_dout sc_in sc_lv 9 signal 2 } 
	{ HwReg_width_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ HwReg_width_fifo_cap sc_in sc_lv 3 signal 2 } 
	...
	{ HwReg_width_c21_din sc_out sc_lv 9 signal 5 } 
	{ HwReg_width_c21_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c21_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ HwReg_width_c21_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_width_c21_write sc_out sc_logic 1 signal 5 } 
	{ HwReg_height_c27_din sc_out sc_lv 9 signal 6 } 
	{ HwReg_height_c27_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ HwReg_height_c27_fifo_cap sc_in sc_lv 3 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_height_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_height", "role": "dout" }} , 
 	{ "name": "HwReg_height_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height", "role": "fifo_cap" }} , 
 	...
 	{ "name": "HwReg_width_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_width", "role": "dout" }} , 
 	{ "name": "HwReg_width_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width", "role": "fifo_cap" }} , 
 	...
 	{ "name": "HwReg_width_c21_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_width_c21", "role": "din" }} , 
 	{ "name": "HwReg_width_c21_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c21", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_c21_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c21", "role": "fifo_cap" }} , 
 	...
 	{ "name": "HwReg_height_c27_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_height_c27", "role": "din" }} , 
 	{ "name": "HwReg_height_c27_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c27", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_c27_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c27", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "stream_in_vresampled", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_hcresampler_core_2_Pipeline_VITIS_LOOP_769_2_fu_182", "Port" : "stream_in_vresampled", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "stream_in_hresampled", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_hcresampler_core_2_Pipeline_VITIS_LOOP_769_2_fu_182", "Port" : "stream_in_hresampled", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_hcresampler_core_2_Pipeline_VITIS_LOOP_769_2_fu_182", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_hcresampler_core_2_Pipeline_VITIS_LOOP_769_2_fu_182.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	HwReg_height { ap_fifo {  { HwReg_height_dout fifo_data_in 0 9 }  { HwReg_height_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_fifo_cap fifo_update 0 3 }  { HwReg_height_empty_n fifo_status 0 1 }  { HwReg_height_read fifo_port_we 1 1 } } }
	HwReg_width { ap_fifo {  { HwReg_width_dout fifo_data_in 0 9 }  { HwReg_width_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_fifo_cap fifo_update 0 3 }  { HwReg_width_empty_n fifo_status 0 1 }  { HwReg_width_read fifo_port_we 1 1 } } }
	...
	HwReg_width_c21 { ap_fifo {  { HwReg_width_c21_din fifo_data_in 1 9 }  { HwReg_width_c21_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_c21_fifo_cap fifo_update 0 3 }  { HwReg_width_c21_full_n fifo_status 0 1 }  { HwReg_width_c21_write fifo_port_we 1 1 } } }
	HwReg_height_c27 { ap_fifo {  { HwReg_height_c27_din fifo_data_in 1 9 }  { HwReg_height_c27_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_c27_fifo_cap fifo_update 0 3 }  { HwReg_height_c27_full_n fifo_status 0 1 }  { HwReg_height_c27_write fifo_port_we 1 1 } } }
}
