...
set C_modelArgList {
	...
	{ height int 9 regular {fifo 0}  }
	{ width int 9 regular {fifo 0}  }
	...
	{ HwReg_width_c20 int 9 regular {fifo 1}  }
	{ HwReg_height_c26 int 9 regular {fifo 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "stream_in_hresampled", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "height", "interface" : "fifo", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "width", "interface" : "fifo", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_width_c20", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c26", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ height_dout sc_in sc_lv 9 signal 1 } 
	...
	{ width_dout sc_in sc_lv 9 signal 2 } 
	...
	{ HwReg_width_c20_din sc_out sc_lv 9 signal 18 } 
	{ HwReg_width_c20_num_data_valid sc_in sc_lv 3 signal 18 } 
	{ HwReg_width_c20_fifo_cap sc_in sc_lv 3 signal 18 } 
	{ HwReg_width_c20_full_n sc_in sc_logic 1 signal 18 } 
	{ HwReg_width_c20_write sc_out sc_logic 1 signal 18 } 
	{ HwReg_height_c26_din sc_out sc_lv 9 signal 19 } 
	{ HwReg_height_c26_num_data_valid sc_in sc_lv 3 signal 19 } 
	{ HwReg_height_c26_fifo_cap sc_in sc_lv 3 signal 19 } 
	{ HwReg_height_c26_full_n sc_in sc_logic 1 signal 19 } 
	{ HwReg_height_c26_write sc_out sc_logic 1 signal 19 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "height_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "height", "role": "dout" }} , 
 	...
 	{ "name": "width_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "width", "role": "dout" }} , 
 	...
 	{ "name": "HwReg_width_c20_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_width_c20", "role": "din" }} , 
 	{ "name": "HwReg_width_c20_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c20", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_c20_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c20", "role": "fifo_cap" }} , 
 	...
 	{ "name": "HwReg_height_c26_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "HwReg_height_c26", "role": "din" }} , 
 	{ "name": "HwReg_height_c26_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c26", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_c26_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c26", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "stream_in_hresampled", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208", "Port" : "stream_in_hresampled", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mul_8ns_16s_24_2_1_U135", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mul_8ns_16s_24_2_1_U136", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mul_8ns_16s_24_2_1_U137", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mul_8ns_16s_24_2_1_U138", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mul_8ns_16s_24_2_1_U139", "Parent" : "1"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mul_8ns_16s_24_2_1_U140", "Parent" : "1"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mac_muladd_16s_8ns_22s_25_4_1_U141", "Parent" : "1"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mac_muladd_16s_8ns_22s_25_4_1_U142", "Parent" : "1"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208.mac_muladd_16s_8ns_22s_25_4_1_U143", "Parent" : "1"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "265721"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "265721"}
]}
...
set Spec2ImplPortList { 
	...
	height { ap_fifo {  { height_dout fifo_data_in 0 9 }  { height_num_data_valid fifo_status_num_data_valid 0 3 }  { height_fifo_cap fifo_update 0 3 }  { height_empty_n fifo_status 0 1 }  { height_read fifo_port_we 1 1 } } }
	width { ap_fifo {  { width_dout fifo_data_in 0 9 }  { width_num_data_valid fifo_status_num_data_valid 0 3 }  { width_fifo_cap fifo_update 0 3 }  { width_empty_n fifo_status 0 1 }  { width_read fifo_port_we 1 1 } } }
	...
	HwReg_width_c20 { ap_fifo {  { HwReg_width_c20_din fifo_data_in 1 9 }  { HwReg_width_c20_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_c20_fifo_cap fifo_update 0 3 }  { HwReg_width_c20_full_n fifo_status 0 1 }  { HwReg_width_c20_write fifo_port_we 1 1 } } }
	HwReg_height_c26 { ap_fifo {  { HwReg_height_c26_din fifo_data_in 1 9 }  { HwReg_height_c26_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_c26_fifo_cap fifo_update 0 3 }  { HwReg_height_c26_full_n fifo_status 0 1 }  { HwReg_height_c26_write fifo_port_we 1 1 } } }
}
