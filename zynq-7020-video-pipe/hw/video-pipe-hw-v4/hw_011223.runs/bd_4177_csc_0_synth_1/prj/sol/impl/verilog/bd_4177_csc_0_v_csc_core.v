...
module bd_4177_csc_0_v_csc_core (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [8:0] HwReg_width_c20_din;
...
output  [8:0] HwReg_height_c26_din;
...
reg    ap_block_state1;
wire   [21:0] offsetR_fu_233_p3;
reg   [21:0] offsetR_reg_365;
wire   [21:0] offsetG_fu_241_p3;
reg   [21:0] offsetG_reg_370;
wire   [21:0] offsetB_fu_249_p3;
reg   [21:0] offsetB_reg_375;
wire   [9:0] add_ln134_fu_261_p2;
reg   [9:0] add_ln134_reg_380;
wire   [9:0] add_ln134_1_fu_271_p2;
reg   [9:0] add_ln134_1_reg_385;
...
wire    grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208_stream_in_hresampled_read;
...
reg   [9:0] y_fu_92;
wire   [9:0] y_8_fu_290_p2;
wire   [9:0] loopWidth_cast_fu_257_p1;
wire   [9:0] height_load_cast_fu_267_p1;
reg   [2:0] ap_NS_fsm;
...
bd_4177_csc_0_v_csc_core_Pipeline_VITIS_LOOP_136_2 grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        offsetB_reg_375[21 : 12] <= offsetB_fu_249_p3[21 : 12];
        offsetG_reg_370[21 : 12] <= offsetG_fu_241_p3[21 : 12];
        offsetR_reg_365[21 : 12] <= offsetR_fu_233_p3[21 : 12];
    end
end
...
assign add_ln134_1_fu_271_p2 = (height_load_cast_fu_267_p1 + 10'd1);

assign add_ln134_fu_261_p2 = (loopWidth_cast_fu_257_p1 + 10'd1);
...
assign offsetB_fu_249_p3 = {{BOffset_read}, {12'd0}};

assign offsetG_fu_241_p3 = {{GOffset_read}, {12'd0}};

assign offsetR_fu_233_p3 = {{ROffset_read}, {12'd0}};

assign stream_csc_din = grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_208_stream_csc_din;

assign y_8_fu_290_p2 = (y_fu_92 + 10'd1);

always @ (posedge ap_clk) begin
    offsetR_reg_365[11:0] <= 12'b000000000000;
    offsetG_reg_370[11:0] <= 12'b000000000000;
    offsetB_reg_375[11:0] <= 12'b000000000000;
end

endmodule //bd_4177_csc_0_v_csc_core
