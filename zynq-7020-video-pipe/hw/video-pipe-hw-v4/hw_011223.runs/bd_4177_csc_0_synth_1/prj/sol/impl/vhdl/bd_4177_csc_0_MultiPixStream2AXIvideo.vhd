...
entity bd_4177_csc_0_MultiPixStream2AXIvideo is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of bd_4177_csc_0_MultiPixStream2AXIvideo is 
...
attribute shreg_extract : string;
    ...
    signal grp_reg_unsigned_short_s_fu_145_ap_return : STD_LOGIC_VECTOR (8 downto 0);
    signal rows_reg_199 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_reg_unsigned_short_s_fu_151_ap_return : STD_LOGIC_VECTOR (8 downto 0);
    signal cols_reg_204 : STD_LOGIC_VECTOR (8 downto 0);
    signal sub_fu_162_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal sub_reg_209 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_stream_out_vresampled_read : STD_LOGIC;
    ...
    signal i_2_fu_176_p2 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    component bd_4177_csc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        m_axis_video_TDEST : OUT STD_LOGIC_VECTOR (0 downto 0);
        p_read : IN STD_LOGIC_VECTOR (7 downto 0);
        sub : IN STD_LOGIC_VECTOR (8 downto 0) );
    end component;


    component bd_4177_csc_0_reg_unsigned_short_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component bd_4177_csc_0_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120 : component bd_4177_csc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        stream_out_vresampled_read => grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_stream_out_vresampled_read,
    ...
    grp_reg_unsigned_short_s_fu_145 : component bd_4177_csc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        d => Height_dout,
    ...
    grp_reg_unsigned_short_s_fu_151 : component bd_4177_csc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        d => WidthOut_dout,
    ...
    regslice_both_m_axis_video_V_data_V_U : component bd_4177_csc_0_regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_keep_V_U : component bd_4177_csc_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_strb_V_U : component bd_4177_csc_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_user_V_U : component bd_4177_csc_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_last_V_U : component bd_4177_csc_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_id_V_U : component bd_4177_csc_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_dest_V_U : component bd_4177_csc_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_ap_done, ap_block_state1, ap_CS_fsm_state5, ap_CS_fsm_state3, icmp_ln662_fu_171_p2, ap_CS_fsm_state6, regslice_both_m_axis_video_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
    ...
    ap_ST_fsm_state5_blk_assign_proc : process(grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_ap_done)
    begin
    ...
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state5);
    ...
    i_2_fu_176_p2 <= std_logic_vector(unsigned(i_fu_84) + unsigned(ap_const_lv9_1));
    ...
    stream_out_vresampled_read_assign_proc : process(grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_stream_out_vresampled_read, ap_CS_fsm_state5)
    begin
    ...
    sub_fu_162_p2 <= std_logic_vector(unsigned(grp_reg_unsigned_short_s_fu_151_ap_return) + unsigned(ap_const_lv9_1FF));
end behav;
